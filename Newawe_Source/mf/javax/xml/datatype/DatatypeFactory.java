...
public abstract class DatatypeFactory {
    ...
    public Duration newDuration(boolean isPositive, int years, int months, int days, int hours, int minutes, int seconds) {
        return newDuration(isPositive, years != ExploreByTouchHelper.INVALID_ID ? BigInteger.valueOf((long) years) : null, months != ExploreByTouchHelper.INVALID_ID ? BigInteger.valueOf((long) months) : null, days != ExploreByTouchHelper.INVALID_ID ? BigInteger.valueOf((long) days) : null, hours != ExploreByTouchHelper.INVALID_ID ? BigInteger.valueOf((long) hours) : null, minutes != ExploreByTouchHelper.INVALID_ID ? BigInteger.valueOf((long) minutes) : null, seconds != ExploreByTouchHelper.INVALID_ID ? BigDecimal.valueOf((long) seconds) : null);
    }
    ...
    public XMLGregorianCalendar newXMLGregorianCalendar(int year, int month, int day, int hour, int minute, int second, int millisecond, int timezone) {
        BigInteger realYear = year != ExploreByTouchHelper.INVALID_ID ? BigInteger.valueOf((long) year) : null;
    ...
    public XMLGregorianCalendar newXMLGregorianCalendarDate(int year, int month, int day, int timezone) {
        return newXMLGregorianCalendar(year, month, day, (int) ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, timezone);
    }

    public XMLGregorianCalendar newXMLGregorianCalendarTime(int hours, int minutes, int seconds, int timezone) {
        return newXMLGregorianCalendar((int) ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, hours, minutes, seconds, ExploreByTouchHelper.INVALID_ID, timezone);
    }
    ...
    public XMLGregorianCalendar newXMLGregorianCalendarTime(int hours, int minutes, int seconds, BigDecimal fractionalSecond, int timezone) {
        return newXMLGregorianCalendar(null, (int) ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, hours, minutes, seconds, fractionalSecond, timezone);
    }
    ...
    public XMLGregorianCalendar newXMLGregorianCalendarTime(int hours, int minutes, int seconds, int milliseconds, int timezone) {
        ...
        if (milliseconds != ExploreByTouchHelper.INVALID_ID) {
            if (milliseconds < 0 || milliseconds > DateUtils.MILLIS_IN_SECOND) {
