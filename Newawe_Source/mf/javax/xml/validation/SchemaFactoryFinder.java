...
class SchemaFactoryFinder {
    ...
    /* renamed from: mf.javax.xml.validation.SchemaFactoryFinder.2 */
    class C08392 implements Iterator {
        private final /* synthetic */ Enumeration val$e;

        C08392(Enumeration enumeration) {
    ...
    /* renamed from: mf.javax.xml.validation.SchemaFactoryFinder.1 */
    class C12601 extends SingleIterator {
        C12601() {
            super();
        }
    ...
    private SchemaFactory _newFactory(String schemaLanguage) {
        ...
        if (schemaLanguage.equals(XMLGrammarDescription.XML_SCHEMA)) {
    ...
    private SchemaFactory loadFromService(String schemaLanguage, String inputName, InputStream in) throws IOException {
        SchemaFactory schemaFactory = null;
        Class[] stringClassArray = new Class[]{StringUtils.EMPTY.getClass()};
    ...
    private Iterator createServiceFileIterator() {
        ...
        try {
            Enumeration e = ss.getResources(this.classLoader, SERVICE_ID);
    ...
    private static String which(String classname, ClassLoader loader) {
        String classnameAsResource = classname.replace(ClassUtils.PACKAGE_SEPARATOR_CHAR, '/') + ".class";
        if (loader == null) {
