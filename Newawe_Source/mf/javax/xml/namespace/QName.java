...
public class QName implements Serializable {
    ...
    class C08231 implements PrivilegedAction {
        C08231() {
        }
    ...
    static {
        ...
        try {
            String valueUseCompatibleSerialVersionUID = (String) AccessController.doPrivileged(new C08231());
    ...
    public QName(String namespaceURI, String localPart) {
        this(namespaceURI, localPart, StringUtils.EMPTY);
    }
    ...
    public QName(String localPart) {
        this(StringUtils.EMPTY, localPart, StringUtils.EMPTY);
    }
    ...
    public String toString() {
        if (this.namespaceURI.equals(StringUtils.EMPTY)) {
            return this.localPart;
        }
    ...
    public static QName valueOf(String qNameAsString) {
        if (qNameAsString == null) {
            ...
            return new QName(StringUtils.EMPTY, qNameAsString, StringUtils.EMPTY);
        } else {
            if (qNameAsString.charAt(0) != '{') {
                return new QName(StringUtils.EMPTY, qNameAsString, StringUtils.EMPTY);
            }
            if (qNameAsString.startsWith("{}")) {
                throw new IllegalArgumentException("Namespace URI .equals(XMLConstants.NULL_NS_URI), .equals(\"\"), only the local part, \"" + qNameAsString.substring(StringUtils.EMPTY.length() + 2) + "\", " + "should be provided.");
            }
            int endOfNamespaceURI = qNameAsString.indexOf(125);
            if (endOfNamespaceURI != -1) {
                return new QName(qNameAsString.substring(1, endOfNamespaceURI), qNameAsString.substring(endOfNamespaceURI + 1), StringUtils.EMPTY);
            }
