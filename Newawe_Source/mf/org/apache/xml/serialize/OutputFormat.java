...
public class OutputFormat {
    ...
    public OutputFormat() {
        ...
        this._lineSeparator = LineSeparator.Web;
        this._lineWidth = 72;
    ...
    public static String whichMethod(Document doc) {
        ...
        while (node != null) {
            if (node.getNodeType() != (short) 1) {
                if (node.getNodeType() == (short) 3) {
                    ...
                    while (i < value.length()) {
                        if (value.charAt(i) != ' ' && value.charAt(i) != '\n' && value.charAt(i) != '\t' && value.charAt(i) != CharUtils.CR) {
                            return Method.XML;
                        }
                        i++;
                    }
            ...
            } else if (node.getNodeName().equalsIgnoreCase(Method.HTML)) {
                return Method.HTML;
            } else {
