...
public class DOMSerializerImpl implements LSSerializer, DOMConfiguration {
    ...
    public DOMSerializerImpl() {
        ...
        this.features = (short) (this.features | XMLEntityManager.DEFAULT_INTERNAL_BUFFER_SIZE);
        this.features = (short) (this.features | NodeFilter.SHOW_DOCUMENT_FRAGMENT);
        this.features = (short) (this.features | 64);
        this.features = (short) (this.features | NodeFilter.SHOW_DOCUMENT);
    ...
    public void setParameter(String name, Object value) throws DOMException {
        if (value instanceof Boolean) {
            ...
            if (name.equalsIgnoreCase(Constants.DOM_INFOSET)) {
                ...
                this.features = (short) (state ? this.features | NodeFilter.SHOW_DOCUMENT : this.features & -257);
            } else if (name.equalsIgnoreCase(Constants.NAMESPACES_FEATURE)) {
                if (state) {
                    r2 = this.features | 1;
                } else {
                    r2 = this.features & -2;
                ...
                if (state) {
                    r2 = this.features | XMLEntityManager.DEFAULT_BUFFER_SIZE;
                } else {
                ...
                if (state) {
                    r2 = this.features | XMLEntityManager.DEFAULT_INTERNAL_BUFFER_SIZE;
                } else {
            ...
            throw new DOMException(CDATA, DOMMessageFormatter.formatMessage(DOMMessageFormatter.DOM_DOMAIN, "FEATURE_NOT_FOUND", new Object[]{name}));
        }
    }
    ...
    public DOMStringList getParameterNames() {
        if (this.fRecognizedParameters == null) {
            ...
            parameters.add(Constants.NAMESPACES_FEATURE);
    ...
    public Object getParameter(String name) throws DOMException {
        if (name.equalsIgnoreCase(Constants.DOM_COMMENTS)) {
            ...
            if (name.equalsIgnoreCase(Constants.DOM_XMLDECL)) {
                return (this.features & NodeFilter.SHOW_DOCUMENT) != 0 ? Boolean.TRUE : Boolean.FALSE;
            } else {
                        ...
                        if (name.equalsIgnoreCase(Constants.DOM_SPLIT_CDATA)) {
                            ...
                            if (name.equalsIgnoreCase(Constants.DOM_WELLFORMED)) {
                                ...
                                if (name.equalsIgnoreCase(Constants.DOM_NAMESPACE_DECLARATIONS)) {
                                    return (this.features & XMLEntityManager.DEFAULT_INTERNAL_BUFFER_SIZE) != 0 ? Boolean.TRUE : Boolean.FALSE;
                                } else {
                                    ...
                                    if (name.equalsIgnoreCase(Constants.DOM_DISCARD_DEFAULT_CONTENT)) {
                                        ...
                                        if (name.equalsIgnoreCase(Constants.DOM_FORMAT_PRETTY_PRINT)) {
                                            return (this.features & XMLEntityManager.DEFAULT_BUFFER_SIZE) != 0 ? Boolean.TRUE : Boolean.FALSE;
                                        } else {
                                            if (name.equalsIgnoreCase(Constants.DOM_INFOSET)) {
                                                if ((this.features & 4) != 0 || (this.features & 8) != 0 || (this.features & 1) == 0 || (this.features & XMLEntityManager.DEFAULT_INTERNAL_BUFFER_SIZE) == 0 || (this.features & 2) == 0 || (this.features & 32) == 0) {
                                                    return Boolean.FALSE;
                                                }
                                                return Boolean.TRUE;
    ...
    public String writeToString(Node wnode) throws DOMException, LSException {
        ...
        try {
            ...
            ser._format.setEncoding(HTTP.UTF_16);
            ...
            } else if (wnode.getNodeType() == NAMESPACES) {
            ...
            throw new DOMException(WELLFORMED, DOMMessageFormatter.formatMessage(DOMMessageFormatter.DOM_DOMAIN, "STRING_TOO_LONG", new Object[]{ioe.getMessage()}));
        } catch (Throwable th) {
            ser.clearDocumentState();
        }
    }
    ...
    public boolean write(Node node, LSOutput destination) throws LSException {
        ...
        try {
            ...
            } else if (node.getNodeType() == NAMESPACES) {
    ...
    private void prepareForSerialization(XMLSerializer ser, Node node) {
        ...
        if ((this.features & XMLEntityManager.DEFAULT_INTERNAL_BUFFER_SIZE) != 0) {
            z = true;
        } else {
            z = false;
        }
        ...
        if ((this.features & XMLEntityManager.DEFAULT_BUFFER_SIZE) != 0) {
            z = true;
        } else {
            z = false;
        }
        ...
        if ((this.features & NodeFilter.SHOW_DOCUMENT) != 0) {
            z2 = false;
        }
