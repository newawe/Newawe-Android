...
public class resolver {
    ...
    static {
        debug = CatalogManager.getStaticManager().debug;
    }
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        if (resTypeStr.equalsIgnoreCase("doctype")) {
            ...
            if (resTypeStr.equalsIgnoreCase("document")) {
                resType = Catalog.DOCUMENT;
            } else {
                if (resTypeStr.equalsIgnoreCase("entity")) {
                    ...
                    if (resTypeStr.equalsIgnoreCase("notation")) {
                        ...
                        if (resTypeStr.equalsIgnoreCase("public")) {
                            ...
                            if (resTypeStr.equalsIgnoreCase("system")) {
                                ...
                                if (resTypeStr.equalsIgnoreCase("uri")) {
                                    resType = Catalog.URI;
                                    if (uri == null) {
