...
final class ElementSchemePointer implements XPointerPart {
        ...
        private int scanNCName(String data, int endOffset, int currentOffset) {
            ...
            while (true) {
                ...
                if (currentOffset < endOffset) {
                    ...
                    if (ch < TransportMediator.FLAG_KEY_MEDIA_NEXT) {
                        chartype = this.fASCIICharMap[ch];
                        if (!(chartype == CHARTYPE_LETTER || chartype == 5 || chartype == 3 || chartype == 2 || chartype == CHARTYPE_UNDERSCORE)) {
                            break;
                        }
    ...
    private final class Tokens {
        ...
        private Tokens(SymbolTable symbolTable) {
            ...
            this.fTokenNames.put(new Integer(XPTRTOKEN_ELEM_CHILD), "XPTRTOKEN_ELEM_CHILD");
        }
        ...
        private void addToken(int token) {
            try {
                ...
                this.fTokens = new int[(this.fTokenCount << XPTRTOKEN_ELEM_CHILD)];
                System.arraycopy(oldList, 0, this.fTokens, 0, this.fTokenCount);
                this.fTokens[this.fTokenCount] = token;
            }
            this.fTokenCount += XPTRTOKEN_ELEM_CHILD;
        }
        ...
        private int nextToken() throws XNIException {
            ...
            this.fCurrentTokenIndex = i + XPTRTOKEN_ELEM_CHILD;
            return iArr[i];
        }
    ...
    /* renamed from: mf.org.apache.xerces.xpointer.ElementSchemePointer.1 */
    class C12721 extends Scanner {
        C12721(SymbolTable $anonymous0) {
    ...
    public void parseXPointer(String xpointer) throws XNIException {
        ...
        if (!new C12721(this.fSymbolTable).scanExpr(this.fSymbolTable, tokens, xpointer, 0, xpointer.length())) {
