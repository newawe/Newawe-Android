...
public class DOMImplementationImpl extends CoreDOMImplementationImpl implements DOMImplementation {
    ...
    public boolean hasFeature(String feature, String version) {
        ...
        if (!((feature.equalsIgnoreCase("Events") && (anyVersion || version.equals("2.0"))) || ((feature.equalsIgnoreCase("MutationEvents") && (anyVersion || version.equals("2.0"))) || ((feature.equalsIgnoreCase("Traversal") && (anyVersion || version.equals("2.0"))) || (feature.equalsIgnoreCase(HttpHeaders.RANGE) && (anyVersion || version.equals("2.0"))))))) {
