...
public abstract class ParentNode extends ChildNode {
    ...
    /* renamed from: mf.org.apache.xerces.dom.ParentNode.1 */
    class C12631 implements NodeList {
        C12631() {
        }
    ...
    public String getTextContent() throws DOMException {
        ...
        if (child.getNextSibling() == null) {
            return hasTextContent(child) ? ((NodeImpl) child).getTextContent() : StringUtils.EMPTY;
        } else {
