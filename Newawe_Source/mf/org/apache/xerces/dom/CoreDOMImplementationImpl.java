...
public class CoreDOMImplementationImpl implements DOMImplementation, DOMImplementationLS {
    ...
    public CoreDOMImplementationImpl() {
        this.schemaValidators = new SoftReference[SIZE];
        this.xml10DTDValidators = new SoftReference[SIZE];
        this.xml11DTDValidators = new SoftReference[SIZE];
        this.freeSchemaValidatorIndex = -1;
        this.freeXML10DTDValidatorIndex = -1;
        this.freeXML11DTDValidatorIndex = -1;
        this.schemaValidatorsCurrentSize = SIZE;
        this.xml10DTDValidatorsCurrentSize = SIZE;
        this.xml11DTDValidatorsCurrentSize = SIZE;
        this.xml10DTDLoaders = new SoftReference[SIZE];
        this.xml11DTDLoaders = new SoftReference[SIZE];
        this.freeXML10DTDLoaderIndex = -1;
        this.freeXML11DTDLoaderIndex = -1;
        this.xml10DTDLoaderCurrentSize = SIZE;
        this.xml11DTDLoaderCurrentSize = SIZE;
    ...
    public LSParser createLSParser(short mode, String schemaType) throws DOMException {
        if (mode != (short) 1 || (schemaType != null && !XMLGrammarDescription.XML_SCHEMA.equals(schemaType) && !XMLGrammarDescription.XML_DTD.equals(schemaType))) {
            throw new DOMException((short) 9, DOMMessageFormatter.formatMessage(DOMMessageFormatter.DOM_DOMAIN, "NOT_SUPPORTED_ERR", null));
        } else if (schemaType == null || !schemaType.equals(XMLGrammarDescription.XML_DTD)) {
