...
public class XMLAttributesImpl implements XMLAttributes {
    ...
    public String getQName(int index) {
        ...
        return rawname == null ? StringUtils.EMPTY : rawname;
    }
    ...
    protected int getTableViewBucket(String localpart, String uri) {
        if (uri == null) {
            return (localpart.hashCode() & ASContentModel.AS_UNBOUNDED) % this.fTableViewBuckets;
        }
        return ((localpart.hashCode() + uri.hashCode()) & ASContentModel.AS_UNBOUNDED) % this.fTableViewBuckets;
    }
