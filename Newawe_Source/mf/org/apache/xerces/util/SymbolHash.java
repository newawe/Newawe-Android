...
public class SymbolHash {
    ...
    public SymbolHash() {
        this.fTableSize = HttpStatus.SC_SWITCHING_PROTOCOLS;
        this.fNum = 0;
    ...
    public void put(Object key, Object value) {
        int bucket = (key.hashCode() & ASContentModel.AS_UNBOUNDED) % this.fTableSize;
    ...
    public Object get(Object key) {
        Entry entry = search(key, (key.hashCode() & ASContentModel.AS_UNBOUNDED) % this.fTableSize);
        if (entry != null) {
            return entry.value;
        }
        return null;
