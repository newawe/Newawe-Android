...
public class ErrorHandlerWrapper implements XMLErrorHandler {
    ...
    /* renamed from: mf.org.apache.xerces.util.ErrorHandlerWrapper.1 */
    class C12711 implements XMLLocator {
        ...
        C12711(String str, String str2, int i, int i2) {
    ...
    protected static XMLParseException createXMLParseException(SAXParseException exception) {
        return new XMLParseException(new C12711(exception.getPublicId(), exception.getSystemId(), exception.getColumnNumber(), exception.getLineNumber()), exception.getMessage(), exception);
    }
