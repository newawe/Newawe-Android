...
public class XMLVersionDetector {
    ...
    static {
        XML11_VERSION = new char[]{'1', ClassUtils.PACKAGE_SEPARATOR_CHAR, '1'};
    ...
    public short determineDocVersion(XMLInputSource inputSource) throws IOException {
        ...
        try {
            ...
            if (!scanner.skipDeclSpaces()) {
                ...
                return (short) 1;
            } else if (scanner.skipString(ClientCookie.VERSION_ATTR)) {
            ...
            this.fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "CharConversionFailure", null, (short) 2, e2);
            return (short) -1;
        } catch (EOFException e3) {
            this.fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "PrematureEOF", null, (short) 2);
            return (short) -1;
        }
    }
