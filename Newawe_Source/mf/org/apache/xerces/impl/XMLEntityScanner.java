...
public class XMLEntityScanner implements XMLLocator {
    ...
    /* renamed from: mf.org.apache.xerces.impl.XMLEntityScanner.1 */
    class C08741 extends EOFException {
    ...
    static {
        END_OF_DOCUMENT_ENTITY = new C08741();
    }
    ...
    public final void setEncoding(String encoding) throws IOException {
        ...
        if (this.fCurrentEntity.encoding == null || !this.fCurrentEntity.encoding.equals(encoding)) {
            if (this.fCurrentEntity.encoding != null && this.fCurrentEntity.encoding.startsWith(HTTP.UTF_16)) {
                ...
                if (!ENCODING.equals(HTTP.UTF_16)) {
            ...
            if (length > 0) {
                ...
                if (index != -1) {
                    ...
                    if (!XMLChar.isNCNameStart(this.fCurrentEntity.ch[startLocal])) {
                        this.fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "IllegalQName", null, (short) 2);
                    }
