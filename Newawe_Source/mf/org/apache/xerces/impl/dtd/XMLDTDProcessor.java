...
public class XMLDTDProcessor implements XMLComponent, XMLDTDFilter, XMLDTDContentModelFilter {
    ...
    static {
        RECOGNIZED_FEATURES = new String[]{VALIDATION, WARN_ON_DUPLICATE_ATTDEF, WARN_ON_UNDECLARED_ELEMDEF, NOTIFY_CHAR_REFS};
    ...
    protected static void checkStandaloneEntityRef(String name, DTDGrammar grammar, XMLEntityDecl tempEntityDecl, XMLErrorReporter errorReporter) throws XNIException {
        ...
        if (entIndex > TOP_LEVEL_SCOPE) {
            ...
            if (tempEntityDecl.inExternal) {
                errorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "MSG_REFERENCE_TO_EXTERNALLY_DECLARED_ENTITY_WHEN_STANDALONE", new Object[]{name}, (short) 1);
            }
        }
    }
    ...
    public void elementDecl(String name, String contentModel, Augmentations augs) throws XNIException {
        if (this.fValidation) {
            if (this.fDTDElementDecls.contains(name)) {
                this.fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "MSG_ELEMENT_ALREADY_DECLARED", new Object[]{name}, (short) 1);
            } else {
    ...
    public void attributeDecl(String elementName, String attributeName, String type, String[] enumeration, String defaultType, XMLString defaultValue, XMLString nonNormalizedDefaultValue, Augmentations augs) throws XNIException {
        ...
        if (this.fValidation) {
            ...
            if (grammar.getAttributeDeclIndex(grammar.getElementDeclIndex(elementName), attributeName) != TOP_LEVEL_SCOPE) {
                duplicateAttributeDef = true;
                if (this.fWarnDuplicateAttdef) {
                    this.fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "MSG_DUPLICATE_ATTRIBUTE_DEFINITION", new Object[]{elementName, attributeName}, (short) 0);
                }
            }
            if (type == XMLSymbols.fIDSymbol) {
                if (!(defaultValue == null || defaultValue.length == 0 || (defaultType != null && (defaultType == XMLSymbols.fIMPLIEDSymbol || defaultType == XMLSymbols.fREQUIREDSymbol)))) {
                    this.fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "IDDefaultTypeInvalid", new Object[]{attributeName}, (short) 1);
                }
                if (!this.fTableOfIDAttributeNames.containsKey(elementName)) {
                    ...
                    this.fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "MSG_MORE_THAN_ONE_ID_ATTRIBUTE", new Object[]{elementName, previousIDAttributeName, attributeName}, (short) 1);
                }
            }
            if (type == XMLSymbols.fNOTATIONSymbol) {
                ...
                if (!this.fTableOfNOTATIONAttributeNames.containsKey(elementName)) {
                    ...
                    this.fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "MSG_MORE_THAN_ONE_NOTATION_ATTRIBUTE", new Object[]{elementName, previousNOTATIONAttributeName, attributeName}, (short) 1);
                }
            }
                ...
                for (i = 0; i < enumeration.length; i++) {
                    ...
                    while (j < enumeration.length) {
                        if (enumeration[i].equals(enumeration[j])) {
                            ...
                            String str2 = XMLMessageFormatter.XML_DOMAIN;
            ...
            if (defaultValue != null && (defaultType == null || (defaultType != null && defaultType == XMLSymbols.fFIXEDSymbol))) {
                ...
                if (!ok) {
                    this.fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "MSG_ATT_DEFAULT_INVALID", new Object[]{attributeName, value}, (short) 1);
                }
            }
        }
        if (this.fDTDGrammar != null) {
    ...
    public void internalEntityDecl(String name, XMLString text, XMLString nonNormalizedText, Augmentations augs) throws XNIException {
        if ((this.fDTDGrammar != null ? this.fDTDGrammar : this.fGrammarBucket.getActiveGrammar()).getEntityDeclIndex(name) == TOP_LEVEL_SCOPE) {
            if (this.fDTDGrammar != null) {
    ...
    public void notationDecl(String name, XMLResourceIdentifier identifier, Augmentations augs) throws XNIException {
        if (this.fValidation) {
            if ((this.fDTDGrammar != null ? this.fDTDGrammar : this.fGrammarBucket.getActiveGrammar()).getNotationDeclIndex(name) != TOP_LEVEL_SCOPE) {
                this.fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "UniqueNotationName", new Object[]{name}, (short) 1);
            }
        }
        if (this.fDTDGrammar != null) {
    ...
    public void endDTD(Augmentations augs) throws XNIException {
        ...
        if (this.fValidation) {
            ...
            for (Entry entry : this.fNDataDeclNotations.entrySet()) {
                if (grammar.getNotationDeclIndex((String) entry.getValue()) == TOP_LEVEL_SCOPE) {
                    String entity = (String) entry.getKey();
                    this.fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "MSG_NOTATION_NOT_DECLARED_FOR_UNPARSED_ENTITYDECL", new Object[]{entity, (String) entry.getValue()}, (short) 1);
                }
            }
            for (Entry entry2 : this.fNotationEnumVals.entrySet()) {
                if (grammar.getNotationDeclIndex((String) entry2.getKey()) == TOP_LEVEL_SCOPE) {
                    attributeName = (String) entry2.getValue();
                    this.fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "MSG_NOTATION_NOT_DECLARED_FOR_NOTATIONTYPE_ATTRIBUTE", new Object[]{attributeName, (String) entry2.getKey()}, (short) 1);
                }
            }
            for (Entry entry22 : this.fTableOfNOTATIONAttributeNames.entrySet()) {
                if (grammar.getContentSpecType(grammar.getElementDeclIndex((String) entry22.getKey())) == (short) 1) {
                    ...
                    this.fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "NoNotationOnEmptyElement", new Object[]{(String) entry22.getKey(), attributeName}, (short) 1);
                }
            }
    ...
    public void element(String elementName, Augmentations augs) throws XNIException {
        if (this.fMixed && this.fValidation) {
            if (this.fMixedElementTypes.contains(elementName)) {
                this.fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "DuplicateTypeInMixedContent", new Object[]{this.fDTDElementDeclName, elementName}, (short) 1);
            } else {
    ...
    private void checkDeclaredElements(DTDGrammar grammar, int elementIndex, int contentSpecIndex, XMLContentSpec contentSpec) {
        ...
        if (contentSpec.type == (short) 0) {
            ...
            if (value != null && grammar.getElementDeclIndex(value) == TOP_LEVEL_SCOPE) {
                this.fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "UndeclaredElementInContentSpec", new Object[]{grammar.getElementDeclName(elementIndex).rawname, value}, (short) 0);
            }
