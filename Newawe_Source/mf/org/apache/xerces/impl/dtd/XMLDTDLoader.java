...
public class XMLDTDLoader extends XMLDTDProcessor implements XMLGrammarLoader {
    ...
    static {
        ...
        LOADER_RECOGNIZED_PROPERTIES = new String[]{XMLSchemaValidator.SYMBOL_TABLE, XMLSchemaValidator.ERROR_REPORTER, ERROR_HANDLER, ENTITY_RESOLVER, XMLSchemaValidator.XMLGRAMMAR_POOL, "http://apache.org/xml/properties/internal/validator/dtd", LOCALE};
    }
    ...
    XMLDTDLoader(SymbolTable symbolTable, XMLGrammarPool grammarPool, XMLErrorReporter errorReporter, XMLEntityResolver entityResolver) {
        ...
        this.fEntityManager.setProperty(XMLSchemaValidator.ERROR_REPORTER, errorReporter);
    ...
    public Object getProperty(String propertyId) throws XMLConfigurationException {
        if (propertyId.equals(XMLSchemaValidator.SYMBOL_TABLE)) {
            return this.fSymbolTable;
        }
        if (propertyId.equals(XMLSchemaValidator.ERROR_REPORTER)) {
        ...
        if (propertyId.equals(XMLSchemaValidator.XMLGRAMMAR_POOL)) {
    ...
    public void setProperty(String propertyId, Object value) throws XMLConfigurationException {
        ...
        } else if (propertyId.equals(XMLSchemaValidator.ERROR_REPORTER)) {
        ...
        } else if (propertyId.equals(XMLSchemaValidator.XMLGRAMMAR_POOL)) {
