...
public class XMLEntityManager implements XMLComponent, XMLEntityResolver {
    ...
    /* renamed from: mf.org.apache.xerces.impl.XMLEntityManager.1 */
    class C08731 implements PrivilegedAction {
        C08731() {
        }
    ...
    private static final class CharacterBufferPool {
        ...
        public CharacterBuffer getBuffer(boolean external) {
            ...
            if (external) {
                ...
                return new CharacterBuffer(XMLEntityManager.DEBUG_RESOLVER, this.fInternalBufferSize);
            } else {
    ...
    private static class EncodingInfo {
        ...
        static {
            UTF_8 = new EncodingInfo(HTTP.UTF_8, null, XMLEntityManager.DEBUG_RESOLVER);
            UTF_8_WITH_BOM = new EncodingInfo(HTTP.UTF_8, null, true);
            UTF_16_BIG_ENDIAN = new EncodingInfo(HTTP.UTF_16, Boolean.TRUE, XMLEntityManager.DEBUG_RESOLVER);
            UTF_16_BIG_ENDIAN_WITH_BOM = new EncodingInfo(HTTP.UTF_16, Boolean.TRUE, true);
            UTF_16_LITTLE_ENDIAN = new EncodingInfo(HTTP.UTF_16, Boolean.FALSE, XMLEntityManager.DEBUG_RESOLVER);
            UTF_16_LITTLE_ENDIAN_WITH_BOM = new EncodingInfo(HTTP.UTF_16, Boolean.FALSE, true);
            UCS_4_BIG_ENDIAN = new EncodingInfo("ISO-10646-UCS-4", Boolean.TRUE, XMLEntityManager.DEBUG_RESOLVER);
            UCS_4_LITTLE_ENDIAN = new EncodingInfo("ISO-10646-UCS-4", Boolean.FALSE, XMLEntityManager.DEBUG_RESOLVER);
            UCS_4_UNUSUAL_BYTE_ORDER = new EncodingInfo("ISO-10646-UCS-4", null, XMLEntityManager.DEBUG_RESOLVER);
            EBCDIC = new EncodingInfo("CP037", null, XMLEntityManager.DEBUG_RESOLVER);
        }
    ...
    public static abstract class Entity {
        ...
        public void clear() {
            this.name = null;
            this.inExternalSubset = XMLEntityManager.DEBUG_RESOLVER;
        }
    ...
    protected static class ExternalEntity extends Entity {
        ...
        public final boolean isUnparsed() {
            return this.notation != null ? true : XMLEntityManager.DEBUG_RESOLVER;
        }
    ...
    protected static class InternalEntity extends Entity {
        ...
        public final boolean isExternal() {
            return XMLEntityManager.DEBUG_RESOLVER;
        }
    ...
    public class ScannedEntity extends Entity {
        ...
        public ScannedEntity(String name, XMLResourceIdentifier entityLocation, InputStream stream, Reader reader, byte[] byteBuffer, String encoding, boolean literal, boolean mayReadChunks, boolean isExternal) {
            ...
            this.lineNumber = 1;
            this.columnNumber = 1;
            this.externallySpecifiedEncoding = XMLEntityManager.DEBUG_RESOLVER;
            this.xmlVersion = "1.0";
            this.ch = null;
            this.entityLocation = entityLocation;
            this.stream = stream;
    ...
    static {
        RECOGNIZED_FEATURES = new String[]{VALIDATION, EXTERNAL_GENERAL_ENTITIES, EXTERNAL_PARAMETER_ENTITIES, ALLOW_JAVA_ENCODINGS, WARN_ON_DUPLICATE_ENTITYDEF, STANDARD_URI_CONFORMANT};
        ...
        objArr[4] = new Integer(DEFAULT_BUFFER_SIZE);
        ...
        GET_USER_DIR_SYSTEM_PROPERTY = new C08731();
    }
    ...
    public XMLEntityManager(XMLEntityManager entityManager) {
        ...
        this.fCharacterBufferPool = new CharacterBufferPool(this.fBufferSize, DEFAULT_INTERNAL_BUFFER_SIZE);
    ...
    public void addExternalEntity(String name, String publicId, String literalSystemId, String baseSystemId) throws IOException {
        if (!this.fEntities.containsKey(name)) {
            ...
            this.fEntities.put(name, new ExternalEntity(name, new XMLEntityDescriptionImpl(name, publicId, literalSystemId, baseSystemId, expandSystemId(literalSystemId, baseSystemId, DEBUG_RESOLVER)), null, this.fInExternalSubset));
        } else if (this.fWarnDuplicateEntityDef) {
            this.fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "MSG_DUPLICATE_ENTITY_DEFINITION", new Object[]{name}, (short) 0);
        }
    }
    ...
    public boolean isDeclaredEntity(String entityName) {
        return ((Entity) this.fEntities.get(entityName)) != null ? true : DEBUG_RESOLVER;
    }
    ...
    public XMLInputSource resolveEntity(XMLResourceIdentifier resourceIdentifier) throws IOException, XNIException {
        ...
        if (this.fEntityResolver != null) {
            if (needExpand) {
                expandedSystemId = expandSystemId(literalSystemId, baseSystemId, DEBUG_RESOLVER);
            }
    ...
    public void startEntity(String entityName, boolean literal) throws IOException, XNIException {
        ...
        if (entity != null) {
            ...
            if (external && (this.fValidationManager == null || !this.fValidationManager.isCachedDTD())) {
                ...
                boolean general = parameter ? DEBUG_RESOLVER : true;
                if (unparsed || ((general && !this.fExternalGeneralEntities) || (parameter && !this.fExternalParameterEntities))) {
                    if (this.fEntityHandler != null) {
                        ...
                        this.fResourceIdentifier.setValues(externalEntity.entityLocation != null ? externalEntity.entityLocation.getPublicId() : null, extLitSysId, extBaseSysId, expandSystemId(extLitSysId, extBaseSysId, DEBUG_RESOLVER));
            ...
            for (int i = size; i >= 0; i--) {
                ...
                if (activeEntity.name == entityName) {
                    ...
                    this.fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "RecursiveReference", new Object[]{entityName, stringBuffer.toString()}, (short) 2);
                    if (this.fEntityHandler != null) {
                        this.fResourceIdentifier.clear();
                        if (external) {
                            externalEntity = (ExternalEntity) entity;
    ...
    public void startEntity(String name, XMLInputSource xmlInputSource, boolean literal, boolean isExternal) throws IOException, XNIException {
        ...
        if (this.fSecurityManager != null) {
            ...
            if (i > this.fEntityExpansionLimit) {
                this.fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "EntityExpansionLimitExceeded", new Object[]{new Integer(this.fEntityExpansionLimit)}, (short) 2);
                this.fEntityExpansionCount = 0;
            }
        }
        if (this.fEntityHandler != null) {
    ...
    public String setupCurrentEntity(String name, XMLInputSource xmlInputSource, boolean literal, boolean isExternal) throws IOException, XNIException {
        ...
        boolean encodingExternallySpecified = encoding != null ? true : DEBUG_RESOLVER;
        ...
        if (reader == null) {
            ...
            if (encoding == null) {
                ...
                if (count == 4) {
                    ...
                    stream.reset();
                    if (info.hasBOM) {
                        if (encoding == HTTP.UTF_8) {
                            stream.skip(3);
                        } else if (encoding == HTTP.UTF_16) {
                            stream.skip(2);
                        }
                    }
                ...
                if (encoding.equals(HTTP.UTF_8)) {
                    ...
                    reader = createReader(stream, HTTP.UTF_8, null);
                } else if (encoding.equals(HTTP.UTF_16)) {
                    b4 = new int[4];
                    count = 0;
                    while (count < 4) {
                    ...
                    if (count >= 2) {
                        ...
                        if (b0 == 254 && b1 == 255) {
                            ...
                            stream.skip(2);
                        } else if (b0 == MotionEventCompat.ACTION_MASK && b1 == 254) {
                    ...
                    reader = createReader(stream, HTTP.UTF_16, isBigEndian);
        ...
        this.fCurrentEntity = new ScannedEntity(name, new XMLResourceIdentifierImpl(publicId, literalSystemId, baseSystemId, expandedSystemId), stream, reader, this.fTempByteBuffer, encoding, literal, DEBUG_RESOLVER, isExternal);
    ...
    public void reset() {
        ...
        this.fHasPEReferences = DEBUG_RESOLVER;
    ...
    private static synchronized URI getUserDir() throws MalformedURIException {
        ...
        synchronized (XMLEntityManager.class) {
            String userDir = StringUtils.EMPTY;
            try {
                userDir = (String) AccessController.doPrivileged(GET_USER_DIR_SYSTEM_PROPERTY);
            } catch (SecurityException e) {
            }
            if (userDir.length() == 0) {
                uri = new URI("file", StringUtils.EMPTY, StringUtils.EMPTY, null, null);
                ...
                if (i < len) {
                    try {
                        for (byte b : userDir.substring(i).getBytes(HTTP.UTF_8)) {
                            if (b < null) {
                        ...
                        uri = new URI("file", StringUtils.EMPTY, userDir, null, null);
                    }
                }
                if (!userDir.endsWith("/")) {
                    buffer.append('/');
                }
                gUserDirURI = new URI("file", StringUtils.EMPTY, buffer.toString(), null, null);
                uri = gUserDirURI;
            } else {
                uri = gUserDirURI;
            }
                    ...
                    if (!(baseSystemId.length() == 0 || baseSystemId.equals(systemId))) {
                        try {
                            ...
                            if (baseSystemId.indexOf(58) != -1) {
                                base = new URI("file", StringUtils.EMPTY, fixURI(baseSystemId).trim(), null, null);
                            } else {
    ...
    public static OutputStream createOutputStream(String uri) throws IOException {
        ...
        urlCon.setDoInput(DEBUG_RESOLVER);
        urlCon.setDoOutput(true);
        urlCon.setUseCaches(DEBUG_RESOLVER);
        if (urlCon instanceof HttpURLConnection) {
            ((HttpURLConnection) urlCon).setRequestMethod(HttpPut.METHOD_NAME);
        }
    ...
    protected Reader createReader(InputStream inputStream, String encoding, Boolean isBigEndian) throws IOException {
        if (encoding == HTTP.UTF_8 || encoding == null) {
            return createUTF8Reader(inputStream);
        }
        if (encoding == HTTP.UTF_16 && isBigEndian != null) {
        ...
        if (ENCODING.equals(CharEncoding.UTF_16BE)) {
            return createUTF16Reader(inputStream, true);
        }
        if (ENCODING.equals(CharEncoding.UTF_16LE)) {
            return createUTF16Reader(inputStream, DEBUG_RESOLVER);
        }
    ...
    private Reader createUTF8Reader(InputStream stream) {
        ...
        return new UTF8Reader(stream, this.fTempByteBuffer, this.fErrorReporter.getMessageFormatter(XMLMessageFormatter.XML_DOMAIN), this.fErrorReporter.getLocale());
    }
    ...
    private Reader createUTF16Reader(InputStream stream, boolean isBigEndian) {
        ...
        return new UTF16Reader(stream, this.fTempByteBuffer, isBigEndian, this.fErrorReporter.getMessageFormatter(XMLMessageFormatter.XML_DOMAIN), this.fErrorReporter.getLocale());
    }
    ...
    private Reader createASCIIReader(InputStream stream) {
        ...
        return new ASCIIReader(stream, this.fTempByteBuffer, this.fErrorReporter.getMessageFormatter(XMLMessageFormatter.XML_DOMAIN), this.fErrorReporter.getLocale());
    }
