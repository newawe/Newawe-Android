...
public class XMLDocumentScannerImpl extends XMLDocumentFragmentScannerImpl {
            ...
            while (true) {
                ...
                try {
                    switch (XMLDocumentScannerImpl.this.fScannerState) {
                        case XMLDocumentScannerImpl.SCANNER_STATE_DTD_INTERNAL_DECLS /*17*/:
                            ...
                            break;
                        case XMLDocumentScannerImpl.SCANNER_STATE_DTD_EXTERNAL /*18*/:
                            ...
                            again = true;
                            break;
                        case XMLDocumentScannerImpl.SCANNER_STATE_DTD_EXTERNAL_DECLS /*19*/:
                    ...
                    XMLDocumentScannerImpl.this.fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN, "CharConversionFailure", null, (short) 2, e2);
                    return false;
                ...
                try {
                    switch (XMLDocumentScannerImpl.this.fScannerState) {
                        ...
                        case ConnectionResult.SIGN_IN_REQUIRED /*4*/:
                            ...
                            XMLDocumentScannerImpl.this.setDispatcher(XMLDocumentScannerImpl.this.fDTDDispatcher);
                            return true;
                        case XMLDocumentScannerImpl.SCANNER_STATE_PROLOG /*5*/:
                            XMLDocumentScannerImpl.this.fEntityScanner.skipSpaces();
                ...
                try {
                    switch (XMLDocumentScannerImpl.this.fScannerState) {
                        ...
                        case ConnectionResult.INTERNAL_ERROR /*8*/:
                            ...
                            XMLDocumentScannerImpl.this.setScannerState(XMLDocumentScannerImpl.SCANNER_STATE_TRAILING_MISC);
                            break;
                        case XMLDocumentScannerImpl.SCANNER_STATE_TRAILING_MISC /*12*/:
                            XMLDocumentScannerImpl.this.fEntityScanner.skipSpaces();
                            if (!XMLDocumentScannerImpl.this.fEntityScanner.skipChar(60)) {
                                XMLDocumentScannerImpl.this.setScannerState(7);
                                again = true;
    ...
    static {
        ...
        RECOGNIZED_PROPERTIES = new String[]{DTD_SCANNER, VALIDATION_MANAGER, NAMESPACE_CONTEXT};
    ...
    public String[] getRecognizedFeatures() {
        ...
        if (featureIds != null) {
            ...
            length = SCANNER_STATE_XML_DECL;
        }
        String[] combinedFeatureIds = new String[(RECOGNIZED_FEATURES.length + length)];
        if (featureIds != null) {
            System.arraycopy(featureIds, SCANNER_STATE_XML_DECL, combinedFeatureIds, SCANNER_STATE_XML_DECL, featureIds.length);
        }
        System.arraycopy(RECOGNIZED_FEATURES, SCANNER_STATE_XML_DECL, combinedFeatureIds, length, RECOGNIZED_FEATURES.length);
    ...
    public String[] getRecognizedProperties() {
        ...
        if (propertyIds != null) {
            System.arraycopy(propertyIds, SCANNER_STATE_XML_DECL, combinedPropertyIds, SCANNER_STATE_XML_DECL, propertyIds.length);
        }
        System.arraycopy(RECOGNIZED_PROPERTIES, SCANNER_STATE_XML_DECL, combinedPropertyIds, length, RECOGNIZED_PROPERTIES.length);
    ...
    public Boolean getFeatureDefault(String featureId) {
        for (int i = SCANNER_STATE_XML_DECL; i < RECOGNIZED_FEATURES.length; i++) {
    ...
    public Object getPropertyDefault(String propertyId) {
        for (int i = SCANNER_STATE_XML_DECL; i < RECOGNIZED_PROPERTIES.length; i++) {
    ...
    protected boolean scanDoctypeDecl() throws IOException, XNIException {
        ...
        if (this.fEntityScanner.skipSpaces()) {
            ...
            this.fDoctypeSystemId = this.fStrings[SCANNER_STATE_XML_DECL];
    ...
    protected String getScannerStateName(int state) {
        switch (state) {
            case SCANNER_STATE_XML_DECL /*0*/:
                return "SCANNER_STATE_XML_DECL";
            case SCANNER_STATE_PROLOG /*5*/:
                return "SCANNER_STATE_PROLOG";
            case SCANNER_STATE_TRAILING_MISC /*12*/:
                return "SCANNER_STATE_TRAILING_MISC";
            case SCANNER_STATE_DTD_INTERNAL_DECLS /*17*/:
                return "SCANNER_STATE_DTD_INTERNAL_DECLS";
            case SCANNER_STATE_DTD_EXTERNAL /*18*/:
                return "SCANNER_STATE_DTD_EXTERNAL";
            case SCANNER_STATE_DTD_EXTERNAL_DECLS /*19*/:
