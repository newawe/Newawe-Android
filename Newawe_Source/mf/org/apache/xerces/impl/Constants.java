...
public final class Constants {
    ...
    static class ArrayEnumeration implements Enumeration {
        ...
        public boolean hasMoreElements() {
            return this.index < this.array.length ? true : Constants.SCHEMA_1_1_SUPPORT;
        }
    ...
    static {
        NS_XMLSCHEMA = XMLGrammarDescription.XML_SCHEMA.intern();
        NS_DTD = XMLGrammarDescription.XML_DTD.intern();
