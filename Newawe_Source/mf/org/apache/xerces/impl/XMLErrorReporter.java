...
public class XMLErrorReporter implements XMLComponent {
    ...
    /* renamed from: mf.org.apache.xerces.impl.XMLErrorReporter.1 */
    class C12641 extends ErrorHandlerProxy {
        C12641() {
        }
    ...
    static {
        ...
        FEATURE_DEFAULTS = new Boolean[1];
        RECOGNIZED_PROPERTIES = new String[]{ERROR_HANDLER};
        PROPERTY_DEFAULTS = new Object[1];
    }
