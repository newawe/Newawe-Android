...
public class XSObjectListImpl extends AbstractList implements XSObjectList {
    ...
    /* renamed from: mf.org.apache.xerces.impl.xs.util.XSObjectListImpl.1 */
    class C08861 implements ListIterator {
        C08861() {
        }
    ...
    static {
        ...
        EMPTY_ITERATOR = new C08861();
    }

    public XSObjectListImpl() {
        this.fArray = null;
        this.fLength = 0;
        this.fArray = new XSObject[DEFAULT_SIZE];
        this.fLength = 0;
    }
    ...
    public void addXSObject(XSObject object) {
        if (this.fLength == this.fArray.length) {
            XSObject[] temp = new XSObject[(this.fLength + DEFAULT_SIZE)];
