...
public class XSDDescription extends XMLResourceIdentifierImpl implements XMLSchemaDescription {
    ...
    public boolean fromInstance() {
        return this.fContextType == CONTEXT_ATTRIBUTE || this.fContextType == CONTEXT_ELEMENT || this.fContextType == CONTEXT_INSTANCE || this.fContextType == CONTEXT_XSITYPE;
    }
    ...
    public void reset() {
        super.clear();
        this.fContextType = CONTEXT_INITIALIZE;
