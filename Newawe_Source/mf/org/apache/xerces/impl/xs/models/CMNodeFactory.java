...
public class CMNodeFactory {
    ...
    public void reset() {
        if (this.fSecurityManager != null) {
            this.maxNodeLimit = this.fSecurityManager.getMaxOccurNodeLimit() * MULTIPLICITY;
        }
    }
    ...
    public void nodeCountCheck() {
        if (this.fSecurityManager != null) {
            ...
            this.nodeCount = i + MULTIPLICITY;
            if (i > this.maxNodeLimit) {
                Object[] objArr = new Object[MULTIPLICITY];
                objArr[0] = new Integer(this.maxNodeLimit);
                this.fErrorReporter.reportError(XSMessageFormatter.SCHEMA_DOMAIN, "maxOccurLimit", objArr, (short) 2);
                this.nodeCount = 0;
            }
        }
    }
    ...
    public void setProperty(String propertyId, Object value) throws XMLConfigurationException {
        if (propertyId.startsWith(Constants.XERCES_PROPERTY_PREFIX)) {
            ...
            if (suffixLength == Constants.SECURITY_MANAGER_PROPERTY.length() && propertyId.endsWith(Constants.SECURITY_MANAGER_PROPERTY)) {
                ...
                this.maxNodeLimit = this.fSecurityManager != null ? this.fSecurityManager.getMaxOccurNodeLimit() * MULTIPLICITY : 0;
