...
public class BaseDVFactory extends SchemaDVFactory {
    ...
    static void createBuiltInTypes(SymbolHash types) {
        ...
        String DATE = SchemaSymbols.ATTVAL_DATE;
        ...
        String TIME = SchemaSymbols.ATTVAL_TIME;
        ...
        XSSimpleTypeDecl stringDV = new XSSimpleTypeDecl(anySimpleType, SchemaSymbols.ATTVAL_STRING, (short) 1, (short) 0, false, false, false, true, (short) 2);
        types.put(SchemaSymbols.ATTVAL_STRING, stringDV);
        ...
        symbolHash.put(str, new XSSimpleTypeDecl(anySimpleType, SchemaSymbols.ATTVAL_TIME, (short) 8, (short) 1, false, false, false, true, (short) 9));
        symbolHash = types;
        str = SchemaSymbols.ATTVAL_DATE;
        symbolHash.put(str, new XSSimpleTypeDecl(anySimpleType, SchemaSymbols.ATTVAL_DATE, (short) 9, (short) 1, false, false, false, true, (short) 10));
        symbolHash = types;
        ...
        XSSimpleTypeDecl nonPositiveDV = new XSSimpleTypeDecl(integerDV, SchemaSymbols.ATTVAL_NONPOSITIVEINTEGER, URI_SCHEMAFORSCHEMA, (short) 0, false, null, (short) 31);
        ...
        XSSimpleTypeDecl negativeDV = new XSSimpleTypeDecl(nonPositiveDV, SchemaSymbols.ATTVAL_NEGATIVEINTEGER, URI_SCHEMAFORSCHEMA, (short) 0, false, null, (short) 32);
        ...
        XSSimpleTypeDecl longDV = new XSSimpleTypeDecl(integerDV, SchemaSymbols.ATTVAL_LONG, URI_SCHEMAFORSCHEMA, (short) 0, false, null, (short) 33);
        ...
        XSSimpleTypeDecl intDV = new XSSimpleTypeDecl(longDV, SchemaSymbols.ATTVAL_INT, URI_SCHEMAFORSCHEMA, (short) 0, false, null, (short) 34);
        ...
        XSSimpleTypeDecl shortDV = new XSSimpleTypeDecl(intDV, SchemaSymbols.ATTVAL_SHORT, URI_SCHEMAFORSCHEMA, (short) 0, false, null, (short) 35);
        ...
        XSSimpleTypeDecl byteDV = new XSSimpleTypeDecl(shortDV, SchemaSymbols.ATTVAL_BYTE, URI_SCHEMAFORSCHEMA, (short) 0, false, null, (short) 36);
        ...
        XSSimpleTypeDecl nonNegativeDV = new XSSimpleTypeDecl(integerDV, SchemaSymbols.ATTVAL_NONNEGATIVEINTEGER, URI_SCHEMAFORSCHEMA, (short) 0, false, null, (short) 37);
        ...
        XSSimpleTypeDecl unsignedLongDV = new XSSimpleTypeDecl(nonNegativeDV, SchemaSymbols.ATTVAL_UNSIGNEDLONG, URI_SCHEMAFORSCHEMA, (short) 0, false, null, (short) 38);
        ...
        XSSimpleTypeDecl unsignedIntDV = new XSSimpleTypeDecl(unsignedLongDV, SchemaSymbols.ATTVAL_UNSIGNEDINT, URI_SCHEMAFORSCHEMA, (short) 0, false, null, (short) 39);
        ...
        XSSimpleTypeDecl unsignedShortDV = new XSSimpleTypeDecl(unsignedIntDV, SchemaSymbols.ATTVAL_UNSIGNEDSHORT, URI_SCHEMAFORSCHEMA, (short) 0, false, null, (short) 40);
        ...
        XSSimpleTypeDecl unsignedByteDV = new XSSimpleTypeDecl(unsignedShortDV, SchemaSymbols.ATTVAL_UNSIGNEDBYTE, URI_SCHEMAFORSCHEMA, (short) 0, false, null, (short) 41);
        ...
        XSSimpleTypeDecl positiveIntegerDV = new XSSimpleTypeDecl(nonNegativeDV, SchemaSymbols.ATTVAL_POSITIVEINTEGER, URI_SCHEMAFORSCHEMA, (short) 0, false, null, (short) 42);
