...
public class DateDV extends DateTimeDV {
    ...
    protected XMLGregorianCalendar getXMLGregorianCalendar(DateTimeData date) {
        ...
        return datatypeFactory.newXMLGregorianCalendar(i2, i3, i4, (int) ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, i);
    }
}
