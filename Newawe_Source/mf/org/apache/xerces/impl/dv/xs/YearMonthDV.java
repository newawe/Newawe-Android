...
public class YearMonthDV extends AbstractDateTimeDV {
    ...
    protected XMLGregorianCalendar getXMLGregorianCalendar(DateTimeData date) {
        ...
        return datatypeFactory.newXMLGregorianCalendar(i2, i3, (int) ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, i);
    }
}
