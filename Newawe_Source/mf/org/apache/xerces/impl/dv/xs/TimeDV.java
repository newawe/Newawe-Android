...
public class TimeDV extends AbstractDateTimeDV {
    ...
    protected XMLGregorianCalendar getXMLGregorianCalendar(DateTimeData date) {
        ...
        return datatypeFactory.newXMLGregorianCalendar(null, (int) ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, i2, i3, i4, fractionalSecondsAsBigDecimal, i);
    }
}
