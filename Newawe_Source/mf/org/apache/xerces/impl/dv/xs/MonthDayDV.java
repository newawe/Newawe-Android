...
public class MonthDayDV extends AbstractDateTimeDV {
    ...
    protected DateTimeData parse(String str) throws SchemaDateTimeException {
        ...
        if (str.charAt(0) == '-' && str.charAt(1) == '-') {
            ...
            date.day = parseInt(str, start, MONTHDAY_SIZE);
    ...
    protected XMLGregorianCalendar getXMLGregorianCalendar(DateTimeData date) {
        ...
        return datatypeFactory.newXMLGregorianCalendar((int) ExploreByTouchHelper.INVALID_ID, i2, i3, ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID, i);
    }
}
