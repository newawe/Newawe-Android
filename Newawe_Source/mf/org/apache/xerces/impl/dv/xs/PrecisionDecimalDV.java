...
class PrecisionDecimalDV extends TypeValidator {
    ...
    static class XPrecisionDecimal {
        ...
        XPrecisionDecimal(String content) throws NumberFormatException {
            ...
            this.intDigits = 0;
            this.fracDigits = 0;
            this.ivalue = StringUtils.EMPTY;
            this.fvalue = StringUtils.EMPTY;
            this.pvalue = 0;
        ...
        void initD(String content) throws NumberFormatException {
            ...
            if (intEnd < len) {
                if (content.charAt(intEnd) != ClassUtils.PACKAGE_SEPARATOR_CHAR && content.charAt(intEnd) != 'E' && content.charAt(intEnd) != 'e') {
                    throw new NumberFormatException();
                } else if (content.charAt(intEnd) == ClassUtils.PACKAGE_SEPARATOR_CHAR) {
                    fracStart = intEnd + 1;
                    fracEnd = fracStart;
