...
public abstract class BaseSchemaDVFactory extends SchemaDVFactory {
    ...
    protected static void createBuiltInTypes(SymbolHash builtInTypes, XSSimpleTypeDecl baseAtomicType) {
        ...
        symbolHash.put(str, new XSSimpleTypeDecl(baseAtomicType, SchemaSymbols.ATTVAL_TIME, (short) 8, (short) 1, false, false, false, true, (short) 9));
        symbolHash = builtInTypes;
        str = SchemaSymbols.ATTVAL_DATE;
        symbolHash.put(str, new XSSimpleTypeDecl(baseAtomicType, SchemaSymbols.ATTVAL_DATE, (short) 9, (short) 1, false, false, false, true, (short) 10));
        symbolHash = builtInTypes;
        ...
        builtInTypes.put(SchemaSymbols.ATTVAL_ENTITY, xSSimpleTypeDecl);
        facets.minLength = 1;
        ...
        builtInTypes.put(SchemaSymbols.ATTVAL_NMTOKEN, xSSimpleTypeDecl2);
        facets.minLength = 1;
