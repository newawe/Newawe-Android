...
public class DOMParserImpl extends AbstractDOMParser implements LSParser, DOMConfiguration {
    ...
    public DOMParserImpl(XMLParserConfiguration config) {
        ...
        this.fConfiguration.setFeature("http://apache.org/xml/features/dom/defer-node-expansion", DEBUG);
        ...
        this.fConfiguration.setFeature(DYNAMIC_VALIDATION, DEBUG);
        this.fConfiguration.setFeature("http://apache.org/xml/features/dom/create-entity-ref-nodes", DEBUG);
        this.fConfiguration.setFeature("http://apache.org/xml/features/create-cdata-nodes", DEBUG);
        this.fConfiguration.setFeature(Constants.DOM_CANONICAL_FORM, DEBUG);
        ...
        this.fConfiguration.setFeature(Constants.DOM_SUPPORTED_MEDIATYPES_ONLY, DEBUG);
        ...
        try {
            this.fConfiguration.setFeature(NORMALIZE_DATA, DEBUG);
        ...
        if (value instanceof Boolean) {
            ...
            try {
                if (name.equalsIgnoreCase(Constants.DOM_COMMENTS)) {
                    ...
                    if (state) {
                        this.fConfiguration.setFeature(VALIDATION_FEATURE, DEBUG);
                    }
            ...
            if ((value instanceof LSResourceResolver) || value == null) {
                try {
                    this.fConfiguration.setProperty(XMLSchemaValidator.ENTITY_RESOLVER, new DOMEntityResolverWrapper((LSResourceResolver) value));
                    return;
            ...
            if (!(value instanceof String) && value != null) {
                ...
                try {
                    this.fConfiguration.setFeature(XMLSCHEMA, DEBUG);
                    this.fConfiguration.setFeature(XMLSCHEMA_FULL_CHECKING, DEBUG);
    ...
    public Object getParameter(String name) throws DOMException {
        ...
        if (name.equalsIgnoreCase(Constants.DOM_COMMENTS)) {
            ...
            if (name.equalsIgnoreCase(Constants.DOM_NAMESPACE_DECLARATIONS) || name.equalsIgnoreCase(Constants.DOM_WELLFORMED) || name.equalsIgnoreCase(Constants.DOM_IGNORE_UNKNOWN_CHARACTER_DENORMALIZATIONS) || name.equalsIgnoreCase(Constants.DOM_CANONICAL_FORM) || name.equalsIgnoreCase(Constants.DOM_SUPPORTED_MEDIATYPES_ONLY) || name.equalsIgnoreCase(Constants.DOM_SPLIT_CDATA) || name.equalsIgnoreCase(Constants.DOM_CHARSET_OVERRIDES_XML_ENCODING)) {
                ...
                try {
                    XMLEntityResolver entityResolver = (XMLEntityResolver) this.fConfiguration.getProperty(XMLSchemaValidator.ENTITY_RESOLVER);
    ...
    XMLInputSource dom2xmlInputSource(LSInput is) {
        if (is.getCharacterStream() != null) {
            return new XMLInputSource(is.getPublicId(), is.getSystemId(), is.getBaseURI(), is.getCharacterStream(), HTTP.UTF_16);
        }
        ...
        if (is.getStringData() != null && is.getStringData().length() > 0) {
            return new XMLInputSource(is.getPublicId(), is.getSystemId(), is.getBaseURI(), new StringReader(is.getStringData()), HTTP.UTF_16);
        }
