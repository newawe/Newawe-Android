...
public abstract class AbstractSAXParser extends AbstractXMLDocumentParser implements PSVIProvider, Parser, XMLReader {
    ...
    protected static final class AttributesProxy implements AttributeList, Attributes2 {
        ...
        public String getURI(int index) {
            ...
            return uri != null ? uri : StringUtils.EMPTY;
        }
    ...
    static {
        RECOGNIZED_FEATURES = new String[]{NAMESPACES, STRING_INTERNING};
        RECOGNIZED_PROPERTIES = new String[]{LEXICAL_HANDLER, DECLARATION_HANDLER, DOM_NODE};
    }
    ...
    public void startElement(QName element, XMLAttributes attributes, Augmentations augs) throws XNIException {
        try {
            ...
            if (this.fContentHandler != null) {
                if (this.fNamespaces) {
                    ...
                    if (!this.fNamespacePrefixes) {
                        ...
                        for (i = len - 1; i >= 0; i--) {
                            attributes.getName(i, this.fQName);
                            if (this.fQName.prefix == XMLSymbols.PREFIX_XMLNS || this.fQName.rawname == XMLSymbols.PREFIX_XMLNS) {
                                this.fQName.prefix = StringUtils.EMPTY;
                                this.fQName.uri = StringUtils.EMPTY;
                                this.fQName.localpart = StringUtils.EMPTY;
                ...
                String uri = element.uri != null ? element.uri : StringUtils.EMPTY;
                String localpart = this.fNamespaces ? element.localpart : StringUtils.EMPTY;
                this.fAttributesProxy.setAttributes(attributes);
    ...
    public void endElement(QName element, Augmentations augs) throws XNIException {
        try {
            ...
            if (this.fContentHandler != null) {
                this.fAugmentations = augs;
                this.fContentHandler.endElement(element.uri != null ? element.uri : StringUtils.EMPTY, this.fNamespaces ? element.localpart : StringUtils.EMPTY, element.rawname);
                if (this.fNamespaces) {
                    endNamespaceMapping();
                }
            }
    ...
    public void setEntityResolver(EntityResolver resolver) {
        try {
            XMLEntityResolver xer = (XMLEntityResolver) this.fConfiguration.getProperty(XMLSchemaValidator.ENTITY_RESOLVER);
            if (this.fUseEntityResolver2 && (resolver instanceof EntityResolver2)) {
                ...
                this.fConfiguration.setProperty(XMLSchemaValidator.ENTITY_RESOLVER, new EntityResolver2Wrapper((EntityResolver2) resolver));
            } else if (xer instanceof EntityResolverWrapper) {
                ((EntityResolverWrapper) xer).setEntityResolver(resolver);
            } else {
                this.fConfiguration.setProperty(XMLSchemaValidator.ENTITY_RESOLVER, new EntityResolverWrapper(resolver));
            }
        } catch (XMLConfigurationException e) {
        }
    }
    ...
    public EntityResolver getEntityResolver() {
        try {
            XMLEntityResolver xmlEntityResolver = (XMLEntityResolver) this.fConfiguration.getProperty(XMLSchemaValidator.ENTITY_RESOLVER);
