...
final class StAXEventResultBuilder implements StAXDocumentHandler {
    ...
    /* renamed from: mf.org.apache.xerces.jaxp.validation.StAXEventResultBuilder.1 */
    class C08871 implements Iterator {
        C08871() {
        }
    ...
    final class AttributeIterator implements Iterator {
        ...
        public Object next() {
            if (hasNext()) {
                ...
                String str2 = StAXEventResultBuilder.this.fAttrName.uri != null ? StAXEventResultBuilder.this.fAttrName.uri : StringUtils.EMPTY;
    ...
    public void startElement(QName element, XMLAttributes attributes, Augmentations augs) throws XNIException {
        try {
            ...
            this.fEventWriter.add(this.fEventFactory.createStartElement(element.prefix, element.uri != null ? element.uri : StringUtils.EMPTY, element.localpart, getAttributeIterator(attributes, length), getNamespaceIterator(), this.fNamespaceContext.getNamespaceContext()));
        } catch (Exception e) {
    ...
    static {
        EMPTY_COLLECTION_ITERATOR = new C08871();
    }
}
