...
final class StreamValidatorHelper implements ValidatorHelper {
    ...
    public void validate(Source source, Result result) throws SAXException, IOException {
        if ((result instanceof StreamResult) || result == null) {
            ...
            if (config == null) {
                ...
                config.setProperty(ENTITY_RESOLVER, this.fComponentManager.getProperty(ENTITY_RESOLVER));
    ...
    private XMLParserConfiguration initialize() {
        ...
        config.setProperty(ENTITY_RESOLVER, this.fComponentManager.getProperty(ENTITY_RESOLVER));
        config.setProperty(ERROR_HANDLER, this.fComponentManager.getProperty(ERROR_HANDLER));
        XMLErrorReporter errorReporter = (XMLErrorReporter) this.fComponentManager.getProperty(ERROR_REPORTER);
        ...
        config.setProperty(SYMBOL_TABLE, this.fComponentManager.getProperty(SYMBOL_TABLE));
