    ...
    public void startElement(QName element, XMLAttributes attributes, Augmentations augs) throws XNIException {
        try {
            ...
            if (element.prefix.length() > 0) {
                this.fStreamWriter.writeStartElement(element.prefix, element.localpart, element.uri != null ? element.uri : StringUtils.EMPTY);
            ...
            for (i = 0; i < size; i++) {
                ...
                if (this.fAttrName.prefix.length() > 0) {
                    this.fStreamWriter.writeAttribute(this.fAttrName.prefix, this.fAttrName.uri != null ? this.fAttrName.uri : StringUtils.EMPTY, this.fAttrName.localpart, attributes.getValue(i));
