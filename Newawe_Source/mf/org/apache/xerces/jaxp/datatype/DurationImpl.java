...
class DurationImpl extends Duration implements Serializable {
    ...
    static {
        FIELDS = new Field[]{DatatypeConstants.YEARS, DatatypeConstants.MONTHS, DatatypeConstants.DAYS, DatatypeConstants.HOURS, DatatypeConstants.MINUTES, DatatypeConstants.SECONDS};
    ...
    protected DurationImpl(long durationInMilliSeconds) {
        ...
        this.years = null;
        this.months = null;
        this.seconds = BigDecimal.valueOf((l % DateUtils.MILLIS_PER_MINUTE) + ((long) (is0x8000000000000000L ? 1 : 0)), 3);
    ...
    private static boolean isDigitOrPeriod(char ch) {
        return isDigit(ch) || ch == ClassUtils.PACKAGE_SEPARATOR_CHAR;
    }
    ...
    public int compare(Duration rhs) {
        ...
        if (this.years != null && this.years.compareTo(maxintAsBigInteger) == 1) {
            objArr = new Object[2];
            valueOf = String.valueOf(getClass().getName());
            valueOf = DatatypeConstants.YEARS.toString();
            objArr[0] = "#compare(Duration duration)" + r20;
            objArr[1] = this.years.toString();
            ...
            objArr = new Object[2];
            valueOf = String.valueOf(getClass().getName());
            valueOf = DatatypeConstants.MONTHS.toString();
            objArr[0] = "#compare(Duration duration)" + r20;
            objArr[1] = this.months.toString();
            throw new UnsupportedOperationException(DatatypeMessageFormatter.formatMessage(null, "TooLarge", objArr));
        } else if (this.days != null && this.days.compareTo(maxintAsBigInteger) == 1) {
            objArr = new Object[2];
            valueOf = String.valueOf(getClass().getName());
            valueOf = DatatypeConstants.DAYS.toString();
            objArr[0] = "#compare(Duration duration)" + r20;
            objArr[1] = this.days.toString();
            throw new UnsupportedOperationException(DatatypeMessageFormatter.formatMessage(null, "TooLarge", objArr));
        } else if (this.hours != null && this.hours.compareTo(maxintAsBigInteger) == 1) {
            objArr = new Object[2];
            valueOf = String.valueOf(getClass().getName());
            valueOf = DatatypeConstants.HOURS.toString();
            objArr[0] = "#compare(Duration duration)" + r20;
            objArr[1] = this.hours.toString();
            throw new UnsupportedOperationException(DatatypeMessageFormatter.formatMessage(null, "TooLarge", objArr));
        } else if (this.minutes != null && this.minutes.compareTo(maxintAsBigInteger) == 1) {
            objArr = new Object[2];
            valueOf = String.valueOf(getClass().getName());
            valueOf = DatatypeConstants.MINUTES.toString();
            objArr[0] = "#compare(Duration duration)" + r20;
            objArr[1] = this.minutes.toString();
            throw new UnsupportedOperationException(DatatypeMessageFormatter.formatMessage(null, "TooLarge", objArr));
                    ...
                    if (rhsDays == null || rhsDays.compareTo(maxintAsBigInteger) != 1) {
                        ...
                        if (rhsHours == null || rhsHours.compareTo(maxintAsBigInteger) != 1) {
                            ...
                            if (rhsMinutes == null || rhsMinutes.compareTo(maxintAsBigInteger) != 1) {
                                ...
                                objArr = new Object[2];
                                valueOf = String.valueOf(getClass().getName());
                                valueOf = DatatypeConstants.SECONDS.toString();
                                objArr[0] = "#compare(Duration duration)" + r20;
                                objArr[1] = rhsSeconds.toString();
                                throw new UnsupportedOperationException(DatatypeMessageFormatter.formatMessage(null, "TooLarge", objArr));
                            }
                            objArr = new Object[2];
                            valueOf = String.valueOf(getClass().getName());
    ...
    public Duration normalizeWith(Calendar startTimeInstant) {
        ...
        int days = (int) ((getCalendarTimeInMillis(c) - getCalendarTimeInMillis(startTimeInstant)) / DateUtils.MILLIS_PER_DAY);
        if (days < 0) {
            z = false;
        }
