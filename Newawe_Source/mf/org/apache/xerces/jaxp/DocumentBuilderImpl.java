        ...
        if (dbfAttrs != null) {
            for (Entry entry : dbfAttrs.entrySet()) {
                ...
                if (val instanceof Boolean) {
                    ...
                    if (XMLGrammarDescription.XML_SCHEMA.equals(val) && isValidating()) {
                        this.domParser.setFeature(XMLSCHEMA_VALIDATION_FEATURE, true);
                        this.domParser.setProperty(JAXPConstants.JAXP_SCHEMA_LANGUAGE, XMLGrammarDescription.XML_SCHEMA);
                    }
                    ...
                    if (value == null || !XMLGrammarDescription.XML_SCHEMA.equals(value)) {
