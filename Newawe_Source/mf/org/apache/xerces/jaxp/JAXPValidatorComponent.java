...
final class JAXPValidatorComponent extends TeeXMLDocumentFilterImpl implements XMLComponent {
    ...
    /* renamed from: mf.org.apache.xerces.jaxp.JAXPValidatorComponent.1 */
    class C12681 extends TypeInfoProvider {
        C12681() {
        }
    ...
    /* renamed from: mf.org.apache.xerces.jaxp.JAXPValidatorComponent.2 */
    class C12692 extends ErrorHandlerProxy {
        C12692() {
        }
    ...
    /* renamed from: mf.org.apache.xerces.jaxp.JAXPValidatorComponent.3 */
    class C12703 implements LSResourceResolver {
        C12703() {
        }
    ...
    private static final class XNI2SAX extends DefaultXMLDocumentHandler {
        ...
        public void startElement(QName element, XMLAttributes attributes, Augmentations augs) throws XNIException {
            try {
                ...
                uri = element.uri != null ? element.uri : StringUtils.EMPTY;
        ...
        public void endElement(QName element, Augmentations augs) throws XNIException {
            try {
                this.fContentHandler.endElement(element.uri != null ? element.uri : StringUtils.EMPTY, element.localpart, element.rawname);
                int count = this.fNamespaceContext.getDeclaredPrefixCount();
                if (count > 0) {
                    for (int i = 0; i < count; i++) {
    ...
    public JAXPValidatorComponent(ValidatorHandler validatorHandler) {
        ...
        this.validator.setErrorHandler(new C12692());
        this.validator.setResourceResolver(new C12703());
    }
