...
public final class DOMImplementationRegistry {
    ...
    class C09152 implements PrivilegedAction {
        C09152() {
        }
    ...
    class C09163 implements PrivilegedAction {
    ...
    class C09174 implements PrivilegedAction {
        private final /* synthetic */ ClassLoader val$classLoader;
        private final /* synthetic */ String val$name;

        C09174(ClassLoader classLoader, String str) {
    ...
    class C12741 implements DOMImplementationList {
        private final /* synthetic */ Vector val$implementations;

        C12741(Vector vector) {
    ...
    public DOMImplementationList getDOMImplementationList(String features) {
        ...
        return new C12741(implementations);
    }
    ...
    private static String getServiceValue(ClassLoader classLoader) {
        ...
        try {
            ...
            if (is != null) {
                try {
                    rd = new BufferedReader(new InputStreamReader(is, HTTP.UTF_8), DEFAULT_LINE_LENGTH);
    ...
    private static ClassLoader getContextClassLoader() {
        ...
        return (ClassLoader) AccessController.doPrivileged(new C09152());
    }
    ...
    private static String getSystemProperty(String name) {
        ...
        return (String) AccessController.doPrivileged(new C09163(name));
    }

    private static InputStream getResourceAsStream(ClassLoader classLoader, String name) {
        if (!isJRE11()) {
            return (InputStream) AccessController.doPrivileged(new C09174(classLoader, name));
        }
        if (classLoader == null) {
