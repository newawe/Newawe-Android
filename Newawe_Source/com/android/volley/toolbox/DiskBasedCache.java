...
public class DiskBasedCache implements Cache {
    ...
    static class CacheHeader {
        ...
        public static CacheHeader readHeader(InputStream is) throws IOException {
            ...
            if (entry.etag.equals(StringUtils.EMPTY)) {
                entry.etag = null;
            }
        ...
        public boolean writeHeader(OutputStream os) {
            try {
                ...
                DiskBasedCache.writeString(os, this.etag == null ? StringUtils.EMPTY : this.etag);
    ...
    L_0x0011:
        ...
        com.android.volley.VolleyLog.m10e(r9, r10);	 Catch:{ all -> 0x006e }
    L_0x0022:
        monitor-exit(r13);
        return;
    L_0x0024:
