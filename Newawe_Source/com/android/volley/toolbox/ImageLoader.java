...
public class ImageLoader {
    ...
    class C09982 implements Listener<Bitmap> {
    ...
    class C09993 implements ErrorListener {
        final /* synthetic */ String val$cacheKey;
    ...
    public static ImageListener getImageListener(ImageView view, int defaultImageResId, int errorImageResId) {
        return new C13031(errorImageResId, view, defaultImageResId);
    }
    ...
    protected Request<Bitmap> makeImageRequest(String requestUrl, int maxWidth, int maxHeight, ScaleType scaleType, String cacheKey) {
        return new ImageRequest(requestUrl, new C09982(cacheKey), maxWidth, maxHeight, scaleType, Config.RGB_565, new C09993(cacheKey));
    }
