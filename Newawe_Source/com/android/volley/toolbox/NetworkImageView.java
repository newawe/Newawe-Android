...
public class NetworkImageView extends ImageView {
    ...
    class C13041 implements ImageListener {
        ...
        class C02981 implements Runnable {
            ...
            C02981(ImageContainer imageContainer) {
                this.val$response = imageContainer;
            }

            public void run() {
                C13041.this.onResponse(this.val$response, false);
            }
        }
        ...
        public void onResponse(ImageContainer response, boolean isImmediate) {
            if (isImmediate && this.val$isInLayoutPass) {
                NetworkImageView.this.post(new C02981(response));
    ...
    void loadImageIfNecessary(boolean isInLayoutPass) {
        ...
        if (width != 0 || height != 0 || isFullyWrapContent) {
            ...
            this.mImageContainer = this.mImageLoader.get(this.mUrl, new C13041(isInLayoutPass), maxWidth, maxHeight, scaleType);
        }
    }
