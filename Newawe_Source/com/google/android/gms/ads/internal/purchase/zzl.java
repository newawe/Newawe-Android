...
public class zzl {
    public static boolean zza(PublicKey publicKey, String str, String str2) {
        try {
            ...
            zzb.m853e("Signature verification failed.");
            return false;
        } catch (NoSuchAlgorithmException e) {
            zzb.m853e("NoSuchAlgorithmException.");
            return false;
        } catch (InvalidKeyException e2) {
            zzb.m853e("Invalid key specification.");
            return false;
        } catch (SignatureException e3) {
            zzb.m853e("Signature exception.");
            return false;
        }
    }
    ...
    public static boolean zzc(String str, String str2, String str3) {
        ...
        zzb.m853e("Purchase verification failed: missing data.");
        return false;
    }
}
