...
public class zzd extends zza {
    ...
    public void recordPlayBillingResolution(int billingResponseCode) {
        ...
        hashMap.put(NotificationCompatApi21.CATEGORY_STATUS, String.valueOf(zzB(billingResponseCode)));
    ...
    void zzfX() {
        try {
            this.mContext.getClassLoader().loadClass("com.google.ads.conversiontracking.IAPConversionReporter").getDeclaredMethod("reportWithProductId", new Class[]{Context.class, String.class, String.class, Boolean.TYPE}).invoke(null, new Object[]{this.mContext, this.zzFI, StringUtils.EMPTY, Boolean.valueOf(true)});
