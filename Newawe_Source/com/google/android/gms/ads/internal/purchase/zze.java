...
public class zze extends zza implements ServiceConnection {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == DateUtils.SEMI_MONTH) {
            boolean z = false;
            try {
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        ...
        try {
            ...
            this.mActivity.startIntentSenderForResult(pendingIntent.getIntentSender(), DateUtils.SEMI_MONTH, new Intent(), Integer.valueOf(0).intValue(), Integer.valueOf(0).intValue(), Integer.valueOf(0).intValue());
