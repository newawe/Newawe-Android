...
public final class zzs implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    public static class zza extends ViewSwitcher {
        ...
        public void zzbY() {
            zzin.m4114v("Disable position monitoring on adFrame.");
            if (this.zzrV != null) {
                this.zzrV.zzhF();
            }
        }
    ...
    public String zzca() {
        return (this.zzrR && this.zzrS) ? StringUtils.EMPTY : this.zzrR ? this.zzrT ? "top-scrollable" : "top-locked" : this.zzrS ? this.zzrT ? "bottom-scrollable" : "bottom-locked" : StringUtils.EMPTY;
    }
