...
public class zzc extends zzi implements OnAudioFocusChangeListener, OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, SurfaceTextureListener {
    ...
    class C04951 implements Runnable {
        ...
        C04951(zzc com_google_android_gms_ads_internal_overlay_zzc) {
    ...
    class C04962 implements Runnable {
        ...
        C04962(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C04973 implements Runnable {
        ...
        C04973(zzc com_google_android_gms_ads_internal_overlay_zzc, String str, String str2) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
            this.zzEe = str;
            this.zzEf = str2;
        }
    ...
    class C04984 implements Runnable {
        ...
        C04984(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C04995 implements Runnable {
        ...
        C04995(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C05006 implements Runnable {
        ...
        C05006(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C05017 implements Runnable {
        final /* synthetic */ zzc zzEd;

        C05017(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    private void zzfa() {
        Throwable e;
        zzin.m4114v("AdMediaPlayerView init MediaPlayer");
    ...
    private void zzfb() {
        if (zzfe() && this.zzDR.getCurrentPosition() > 0 && this.zzDQ != 3) {
            zzin.m4114v("AdMediaPlayerView nudging MediaPlayer");
            zzb(0.0f);
            this.zzDR.start();
    ...
    private void zzfd() {
        zzin.m4114v("AdMediaPlayerView abandon audio focus");
        AudioManager zzfk = zzfk();
        if (zzfk != null && this.zzEa) {
    ...
    private void zzfh() {
        zzin.m4114v("AdMediaPlayerView audio focus gained");
        this.zzEa = true;
        zzfj();
    }

    private void zzfi() {
        zzin.m4114v("AdMediaPlayerView audio focus lost");
        this.zzEa = false;
        zzfj();
    }
    ...
    private void zzv(boolean z) {
        zzin.m4114v("AdMediaPlayerView release");
        if (this.zzDR != null) {
            this.zzDR.reset();
            this.zzDR.release();
            this.zzDR = null;
    ...
    public void onCompletion(MediaPlayer mp) {
        zzin.m4114v("AdMediaPlayerView completion");
        zzw(5);
        zzx(5);
        zzir.zzMc.post(new C04962(this));
    }
    ...
    public boolean onError(MediaPlayer mp, int what, int extra) {
        ...
        zzw(-1);
        zzx(-1);
        zzir.zzMc.post(new C04973(this, str, str2));
        return true;
    }

    public boolean onInfo(MediaPlayer mp, int what, int extra) {
        String str = (String) zzDN.get(Integer.valueOf(extra));
        zzin.m4114v("AdMediaPlayerView MediaPlayer info: " + ((String) zzDN.get(Integer.valueOf(what))) + ":" + str);
        return true;
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        zzin.m4114v("AdMediaPlayerView prepared");
        zzw(2);
        this.zzDO.zzfz();
        zzir.zzMc.post(new C04951(this));
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        zzin.m4114v("AdMediaPlayerView surface created");
        zzfa();
        zzir.zzMc.post(new C04984(this));
    }

    public boolean onSurfaceTextureDestroyed(SurfaceTexture surface) {
        zzin.m4114v("AdMediaPlayerView surface destroyed");
        if (this.zzDR != null && this.zzEb == 0) {
            this.zzEb = this.zzDR.getCurrentPosition();
        }
        zzir.zzMc.post(new C04995(this));
        zzv(true);
        return true;
    }
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int w, int h) {
        Object obj = 1;
        zzin.m4114v("AdMediaPlayerView surface changed");
    ...
    public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
        zzin.m4114v("AdMediaPlayerView size changed: " + width + " x " + height);
    ...
    public void pause() {
        zzin.m4114v("AdMediaPlayerView pause");
        if (zzfe() && this.zzDR.isPlaying()) {
            this.zzDR.pause();
            zzw(4);
            zzir.zzMc.post(new C05017(this));
        }
        zzx(4);
    }

    public void play() {
        zzin.m4114v("AdMediaPlayerView play");
        if (zzfe()) {
            this.zzDR.start();
            zzw(3);
            zzir.zzMc.post(new C05006(this));
        }
        zzx(3);
    }

    public void seekTo(int millis) {
        zzin.m4114v("AdMediaPlayerView seek " + millis);
        if (zzfe()) {
    ...
    public void stop() {
        zzin.m4114v("AdMediaPlayerView stop");
        if (this.zzDR != null) {
            this.zzDR.stop();
            this.zzDR.release();
            this.zzDR = null;
