...
public class zzk extends FrameLayout implements zzh {
    ...
    private void zzfJ() {
        if (this.zzpD.zzhP() != null && !this.zzEQ) {
            this.zzER = (this.zzpD.zzhP().getWindow().getAttributes().flags & TransportMediator.FLAG_KEY_MEDIA_NEXT) != 0;
            if (!this.zzER) {
                this.zzpD.zzhP().getWindow().addFlags(TransportMediator.FLAG_KEY_MEDIA_NEXT);
                this.zzEQ = true;
            }
        }
    }
    ...
    private void zzfK() {
        if (this.zzpD.zzhP() != null && this.zzEQ && !this.zzER) {
            this.zzpD.zzhP().getWindow().clearFlags(TransportMediator.FLAG_KEY_MEDIA_NEXT);
            this.zzEQ = false;
        }
    }
    ...
    void zzfF() {
        if (this.zzEP != null) {
            ...
            if (this.zzET != currentPosition && currentPosition > 0) {
                ...
                zza("timeupdate", SchemaSymbols.ATTVAL_TIME, String.valueOf(f));
    ...
    public void zzfz() {
        if (this.zzEP != null && this.zzEU == 0) {
            ...
            zza("canplaythrough", SchemaSymbols.ATTVAL_DURATION, String.valueOf(duration), "videoWidth", String.valueOf(videoWidth), "videoHeight", String.valueOf(videoHeight));
        }
    }

    public void zzg(String str, String str2) {
        zza(GCMConstants.EXTRA_ERROR, "what", str, "extra", str2);
    }
}
