...
public class zzd extends com.google.android.gms.internal.zzfv.zza implements zzs {
    ...
    class C10781 implements com.google.android.gms.internal.zzjq.zza {
        final /* synthetic */ zzd zzEv;

        C10781(zzd com_google_android_gms_ads_internal_overlay_zzd) {
    ...
    private class zzd extends zzim {
        ...
        class C05021 implements Runnable {
            ...
            C05021(zzd com_google_android_gms_ads_internal_overlay_zzd_zzd, Drawable drawable) {
        ...
        public void zzbr() {
            ...
            if (zzf != null) {
                zzir.zzMc.post(new C05021(this, zzr.zzbE().zza(this.zzEv.mActivity, zzf, this.zzEv.zzEh.zzEM.zzqo, this.zzEv.zzEh.zzEM.zzqp)));
            }
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            this.zzDm.setId(DateUtils.MILLIS_IN_SECOND);
    ...
    protected void zzx(boolean z) throws zza {
        ...
        if (z) {
            ...
            this.zzpD.zzhU().zza(new C10781(this));
            if (this.zzEh.url != null) {
                this.zzpD.loadUrl(this.zzEh.url);
            } else if (this.zzEh.zzEH != null) {
                this.zzpD.loadDataWithBaseURL(this.zzEh.zzEF, this.zzEh.zzEH, "text/html", HTTP.UTF_8, null);
            } else {
