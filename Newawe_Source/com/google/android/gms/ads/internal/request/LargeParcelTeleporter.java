...
public final class LargeParcelTeleporter implements SafeParcelable {
    ...
    class C05051 implements Runnable {
        ...
        C05051(LargeParcelTeleporter largeParcelTeleporter, OutputStream outputStream, byte[] bArr) {
    ...
    public <T extends SafeParcelable> T zza(Creator<T> creator) {
        if (this.zzIs) {
            if (this.zzIq == null) {
                zzb.m853e("File descriptor is empty, returning null.");
                return null;
            }
    ...
    protected <T> ParcelFileDescriptor zzf(byte[] bArr) {
        ...
        try {
            ...
            try {
                new Thread(new C05051(this, autoCloseOutputStream, bArr)).start();
                return createPipe[0];
            } catch (IOException e2) {
                e = e2;
            }
