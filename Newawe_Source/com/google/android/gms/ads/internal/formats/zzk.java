...
public class zzk extends zza implements OnClickListener, OnTouchListener, OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    /* renamed from: com.google.android.gms.ads.internal.formats.zzk.1 */
    class C04941 implements Runnable {
        final /* synthetic */ zzi zzyJ;
        final /* synthetic */ zzk zzyK;

        C04941(zzk com_google_android_gms_ads_internal_formats_zzk, zzi com_google_android_gms_ads_internal_formats_zzi) {
    ...
    public void zza(zzd com_google_android_gms_dynamic_zzd) {
        synchronized (this.zzpV) {
            ...
            if (zzp instanceof zzi) {
                ...
                zzir.zzMc.post(new C04941(this, com_google_android_gms_ads_internal_formats_zzi));
