...
public class zzq {
    ...
    class C05221 implements Runnable {
        ...
        C05221(zzq com_google_android_gms_ads_internal_zzq, WeakReference weakReference) {
    ...
    zzq(zza com_google_android_gms_ads_internal_zza, zza com_google_android_gms_ads_internal_zzq_zza) {
        ...
        this.zzx = new C05221(this, new WeakReference(com_google_android_gms_ads_internal_zza));
    }
    ...
    public void zzg(AdRequestParcel adRequestParcel) {
        zza(adRequestParcel, (long) DateUtils.MILLIS_PER_MINUTE);
    }
}
