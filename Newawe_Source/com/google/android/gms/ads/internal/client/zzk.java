...
public final class zzk {
    ...
    public zzk(Context context, AttributeSet attributeSet) {
        Object obj = 1;
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0485R.styleable.AdsAttrs);
        Object string = obtainAttributes.getString(C0485R.styleable.AdsAttrs_adSize);
        Object string2 = obtainAttributes.getString(C0485R.styleable.AdsAttrs_adSizes);
        ...
        this.zzpS = obtainAttributes.getString(C0485R.styleable.AdsAttrs_adUnitId);
