...
public class zzd {
    ...
    static class C10911 implements zza<TokenData> {
        final /* synthetic */ Account zzVg;
        final /* synthetic */ String zzVh;
        final /* synthetic */ Bundle zzVi;

        C10911(Account account, String str, Bundle bundle) {
            this.zzVg = account;
            this.zzVh = str;
            this.zzVi = bundle;
        }
    ...
    static class C10922 implements zza<Void> {
        final /* synthetic */ String zzVj;
        final /* synthetic */ Bundle zzVk;

        C10922(String str, Bundle bundle) {
            this.zzVj = str;
            this.zzVk = bundle;
        }
    ...
    static class C10933 implements zza<List<AccountChangeEvent>> {
        final /* synthetic */ String zzVl;
        final /* synthetic */ int zzVm;

        C10933(String str, int i) {
            this.zzVl = str;
            this.zzVm = i;
        }
    ...
    static {
        ...
        zzVe = new ComponentName(zze.GOOGLE_PLAY_SERVICES_PACKAGE, "com.google.android.gms.auth.GetToken");
        zzVf = new ComponentName(zze.GOOGLE_PLAY_SERVICES_PACKAGE, "com.google.android.gms.recovery.RecoveryService");
    }
    ...
    public static void clearToken(Context context, String token) throws GooglePlayServicesAvailabilityException, GoogleAuthException, IOException {
        ...
        zza(context, zzVe, new C10922(token, bundle));
    }
    ...
    public static List<AccountChangeEvent> getAccountChangeEvents(Context context, int eventIndex, String accountName) throws GoogleAuthException, IOException {
        ...
        zzx.zzcE("Calling this from your main thread can lead to deadlock");
        zzad(context);
        return (List) zza(context, zzVe, new C10933(accountName, eventIndex));
    }
    ...
    public static TokenData zzc(Context context, Account account, String str, Bundle bundle) throws IOException, UserRecoverableAuthException, GoogleAuthException {
        ...
        return (TokenData) zza(context, zzVe, new C10911(account, str, bundle2));
    }
