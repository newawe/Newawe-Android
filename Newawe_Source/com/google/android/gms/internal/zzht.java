...
public class zzht extends zzb implements zzhw {
    ...
    class C06121 implements Runnable {
        ...
        C06121(zzht com_google_android_gms_internal_zzht, zza com_google_android_gms_internal_zzif_zza) {
    ...
    private zza zzc(zza com_google_android_gms_internal_zzif_zza) {
        zzin.m4114v("Creating mediation ad response for non-mediated rewarded ad.");
        try {
            ...
            return new zza(com_google_android_gms_internal_zzif_zza.zzLd, com_google_android_gms_internal_zzif_zza.zzLe, new zzeo(Arrays.asList(new zzen[]{com_google_android_gms_internal_zzen}), -1, Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), StringUtils.EMPTY, -1, 0, 1, null, 0, -1, -1), com_google_android_gms_internal_zzif_zza.zzrp, com_google_android_gms_internal_zzif_zza.errorCode, com_google_android_gms_internal_zzif_zza.zzKY, com_google_android_gms_internal_zzif_zza.zzKZ, com_google_android_gms_internal_zzif_zza.zzKT);
        } catch (Throwable e) {
    ...
    public void zza(zza com_google_android_gms_internal_zzif_zza, zzcb com_google_android_gms_internal_zzcb) {
        if (com_google_android_gms_internal_zzif_zza.errorCode != -2) {
            zzir.zzMc.post(new C06121(this, com_google_android_gms_internal_zzif_zza));
            return;
        }
