...
public class zzgv extends zzim {
    ...
    class C06051 implements Runnable {
        ...
        C06051(zzgv com_google_android_gms_internal_zzgv, zzif com_google_android_gms_internal_zzif) {
    ...
    public void zzbr() {
        ...
        try {
            ...
            com_google_android_gms_internal_zzif = (zzif) this.zzGD.get(DateUtils.MILLIS_PER_MINUTE, TimeUnit.MILLISECONDS);
            i = -2;
        ...
        zzir.zzMc.post(new C06051(this, com_google_android_gms_internal_zzif));
    }
}
