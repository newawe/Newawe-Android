...
public class zzgo implements Runnable {
    ...
    public void zza(AdResponseParcel adResponseParcel, zzjy com_google_android_gms_internal_zzjy) {
        ...
        this.zzpD.loadDataWithBaseURL(TextUtils.isEmpty(adResponseParcel.zzEF) ? null : zzr.zzbC().zzaC(adResponseParcel.zzEF), adResponseParcel.body, "text/html", HTTP.UTF_8, null);
    }
