...
public final class zzhe {
        ...
        try {
            ...
            if (adResponseParcel != null) {
                ...
                if (adResponseParcel.zzHS > 0) {
                    ...
                    return new AdResponseParcel(adRequestInfoParcel, optString2, str2, list, list2, j, jSONObject.optBoolean("mediation", false), jSONObject.optLong("mediation_config_cache_time_milliseconds", -1), list3, jSONObject.optLong("refresh_interval_milliseconds", -1), i, optString4, j2, optString6, optBoolean, str3, optString, jSONObject.optBoolean("custom_render_allowed", false), z, adRequestInfoParcel.zzHB, jSONObject.optBoolean("content_url_opted_out", true), jSONObject.optBoolean("prefetch", false), jSONObject.optInt("oauth2_token_status", 0), jSONObject.optString("gws_query_id", StringUtils.EMPTY), "height".equals(jSONObject.optString("fluid", StringUtils.EMPTY)), jSONObject.optBoolean("native_express", false), RewardItemParcel.zza(jSONObject.optJSONArray("rewards")), zza(jSONObject.optJSONArray("video_start_urls"), null), zza(jSONObject.optJSONArray("video_complete_urls"), null), jSONObject.optBoolean("use_displayed_impression", false));
                }
            }
            j = j3;
            optString = jSONObject.optString("active_view");
    ...
    public static JSONObject zza(Context context, AdRequestInfoParcel adRequestInfoParcel, zzhj com_google_android_gms_internal_zzhj, zza com_google_android_gms_internal_zzhn_zza, Location location, zzbm com_google_android_gms_internal_zzbm, String str, String str2, List<String> list, Bundle bundle) {
        try {
            ...
            if (zzb.zzQ(2)) {
                zzin.m4114v("Ad Request JSON: " + zzr.zzbC().zzG(hashMap).toString(2));
            }
    ...
    private static void zza(HashMap<String, Object> hashMap, Location location) {
        ...
        hashMap2.put(SchemaSymbols.ATTVAL_TIME, valueOf2);
    ...
    private static void zza(HashMap<String, Object> hashMap, AdRequestParcel adRequestParcel) {
        ...
        if (adRequestParcel.versionCode >= 3 && adRequestParcel.zztL != null) {
            hashMap.put(DatabaseOpenHelper.HISTORY_ROW_URL, adRequestParcel.zztL);
        }
    ...
    private static void zza(HashMap<String, Object> hashMap, String str) {
        if (str != null) {
            ...
            hashMap2.put(SchemaSymbols.ATTVAL_TOKEN, str);
    ...
    public static JSONObject zzc(AdResponseParcel adResponseParcel) throws JSONException {
        ...
        jSONObject.put("fluid", adResponseParcel.zzul ? "height" : StringUtils.EMPTY);
