...
public class zzan {
    ...
    static {
        zzov = new String[]{"/aclk", "/pcs/click"};
    }

    public zzan(zzaj com_google_android_gms_internal_zzaj) {
        this.zzor = "googleads.g.doubleclick.net";
        this.zzos = "/pagead/ads";
        this.zzot = "ad.doubleclick.net";
        this.zzou = new String[]{".doubleclick.net", ".googleadservices.com", ".googlesyndication.com"};
