...
public class zzdg implements zzdf {
    ...
    class C05601 implements Runnable {
        ...
        class C05591 implements Runnable {
            ...
            final /* synthetic */ C05601 zzzo;

            C05591(C05601 c05601, JSONObject jSONObject) {
                this.zzzo = c05601;
        ...
        C05601(zzdg com_google_android_gms_internal_zzdg, Map map, zzjp com_google_android_gms_internal_zzjp) {
        ...
        public void run() {
            ...
            if (zzQ == null) {
                com.google.android.gms.ads.internal.util.client.zzb.m853e("Response should not be null.");
            } else {
                zzir.zzMc.post(new C05591(this, zzQ));
            }
        }
    }
    ...
    public JSONObject zzQ(String str) {
        try {
            ...
            com.google.android.gms.ads.internal.util.client.zzb.m853e("The request is not a valid JSON.");
            try {
    ...
    protected JSONObject zza(zzd com_google_android_gms_internal_zzdg_zzd) {
        ...
        try {
            ...
            for (zza com_google_android_gms_internal_zzdg_zza : com_google_android_gms_internal_zzdg_zzd.zzdZ()) {
                jSONArray.put(new JSONObject().put("key", com_google_android_gms_internal_zzdg_zza.getKey()).put("value", com_google_android_gms_internal_zzdg_zza.getValue()));
            }
    ...
    public void zza(zzjp com_google_android_gms_internal_zzjp, Map<String, String> map) {
        zziq.zza(new C05601(this, map, com_google_android_gms_internal_zzjp));
    }

    protected zzb zzc(JSONObject jSONObject) {
        URL url;
        String optString = jSONObject.optString("http_request_id");
        String optString2 = jSONObject.optString(DatabaseOpenHelper.HISTORY_ROW_URL);
