...
public class zziu {
    ...
    class C06261 implements OnClickListener {
        ...
        C06261(zziu com_google_android_gms_internal_zziu, String str) {
            this.zzMm = com_google_android_gms_internal_zziu;
            this.zzMl = str;
        }

        public void onClick(DialogInterface dialog, int which) {
            zzr.zzbC().zzb(this.zzMm.mContext, Intent.createChooser(new Intent("android.intent.action.SEND").setType(HTTP.PLAIN_TEXT_TYPE).putExtra("android.intent.extra.TEXT", this.zzMl), "Share via"));
        }
    }
    ...
    class C06272 implements OnClickListener {
        ...
        C06272(zziu com_google_android_gms_internal_zziu) {
            this.zzMm = com_google_android_gms_internal_zziu;
        }
    ...
    private void showDialog() {
        if (this.mContext instanceof Activity) {
            ...
            builder.setPositiveButton("Share", new C06261(this, zzaG));
            builder.setNegativeButton(HTTP.CONN_CLOSE, new C06272(this));
            builder.create().show();
            return;
        }
