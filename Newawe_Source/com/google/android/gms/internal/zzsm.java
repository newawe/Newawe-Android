...
public final class zzsm {
    ...
    private zzsm(byte[] bArr, int i, int i2) {
        this.zzbue = ASContentModel.AS_UNBOUNDED;
        this.zzbug = 64;
        this.zzbuh = 67108864;
        this.buffer = bArr;
        this.zzbtZ = i;
    ...
    public String readString() throws IOException {
        int zzJf = zzJf();
        if (zzJf > this.zzbua - this.zzbuc || zzJf <= 0) {
            return new String(zzmt(zzJf), HTTP.UTF_8);
        }
        String str = new String(this.buffer, this.zzbuc, zzJf, HTTP.UTF_8);
        this.zzbuc = zzJf + this.zzbuc;
        return str;
    }
    ...
    public long zzJg() throws IOException {
        ...
        for (int i = 0; i < 64; i += 7) {
            ...
            if ((zzJm & TransportMediator.FLAG_KEY_MEDIA_NEXT) == 0) {
                return j;
            }
        }
        throw zzst.zzJu();
    ...
    public int zzJh() throws IOException {
        return (((zzJm() & MotionEventCompat.ACTION_MASK) | ((zzJm() & MotionEventCompat.ACTION_MASK) << 8)) | ((zzJm() & MotionEventCompat.ACTION_MASK) << 16)) | ((zzJm() & MotionEventCompat.ACTION_MASK) << 24);
    }
    ...
    public int zzJk() {
        if (this.zzbue == ASContentModel.AS_UNBOUNDED) {
            return -1;
        }
