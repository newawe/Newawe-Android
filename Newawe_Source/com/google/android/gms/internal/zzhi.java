...
class zzhi {
    ...
    public zzhi(int i, Map<String, String> map) {
        this.zzF = (String) map.get(DatabaseOpenHelper.HISTORY_ROW_URL);
    ...
    private static boolean parseBoolean(String bool) {
        return bool != null && (bool.equals(SchemaSymbols.ATTVAL_TRUE_1) || bool.equals(SchemaSymbols.ATTVAL_TRUE));
    }
