...
public class zzfm extends zzfs {
    ...
    class C05931 implements OnClickListener {
        ...
        C05931(zzfm com_google_android_gms_internal_zzfm) {
    ...
    class C05942 implements OnClickListener {
        ...
        C05942(zzfm com_google_android_gms_internal_zzfm) {
            this.zzCZ = com_google_android_gms_internal_zzfm;
        }
    ...
    private String zzaj(String str) {
        return TextUtils.isEmpty((CharSequence) this.zzxA.get(str)) ? StringUtils.EMPTY : (String) this.zzxA.get(str);
    }
    ...
    Intent createIntent() {
        ...
        data.putExtra(DatabaseOpenHelper.HISTORY_ROW_TITLE, this.zzCU);
    ...
    public void execute() {
        if (this.mContext == null) {
            ...
            zzL.setTitle(zzr.zzbF().zzd(C0485R.string.create_calendar_title, "Create calendar event"));
            zzL.setMessage(zzr.zzbF().zzd(C0485R.string.create_calendar_message, "Allow Ad to create a calendar event?"));
            zzL.setPositiveButton(zzr.zzbF().zzd(C0485R.string.accept, XIncludeHandler.HTTP_ACCEPT), new C05931(this));
            zzL.setNegativeButton(zzr.zzbF().zzd(C0485R.string.decline, "Decline"), new C05942(this));
            zzL.create().show();
        } else {
