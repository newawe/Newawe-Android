...
public class zzjq extends WebViewClient {
    ...
    class C06321 implements Runnable {
        ...
        C06321(zzjq com_google_android_gms_internal_zzjq) {
    ...
    static {
        zzNy = new String[]{"UNKNOWN", "HOST_LOOKUP", "UNSUPPORTED_AUTH_SCHEME", "AUTHENTICATION", "PROXY_AUTHENTICATION", "CONNECT", "IO", InstanceID.ERROR_TIMEOUT, "REDIRECT_LOOP", "UNSUPPORTED_SCHEME", "FAILED_SSL_HANDSHAKE", "BAD_URL", "FILE", "FILE_NOT_FOUND", "TOO_MANY_REQUESTS"};
    ...
    public final void onLoadResource(WebView webView, String url) {
        zzin.m4114v("Loading resource: " + url);
    ...
    public final void onPageFinished(WebView webView, String url) {
        synchronized (this.zzpV) {
            if (this.zzNH) {
                zzin.m4114v("Blank page loaded, 1...");
                this.zzpD.zzhZ();
                return;
            }
            this.zzNI = true;
    ...
    public boolean shouldOverrideKeyEvent(WebView view, KeyEvent event) {
        switch (event.getKeyCode()) {
            case C0302R.styleable.Theme_panelMenuListWidth /*79*/:
            case C0302R.styleable.Theme_colorControlNormal /*85*/:
            case C0302R.styleable.Theme_colorControlActivated /*86*/:
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String url) {
        zzin.m4114v("AdWebView shouldOverrideUrlLoading: " + url);
        Uri parse = Uri.parse(url);
        if ("gmsg".equalsIgnoreCase(parse.getScheme()) && "mobileads.google.com".equalsIgnoreCase(parse.getHost())) {
            zzh(parse);
    ...
    public final void zzfo() {
        synchronized (this.zzpV) {
            this.zzND = false;
            this.zzsz = true;
            zzir.runOnUiThread(new C06321(this));
        }
    }
    ...
    public void zzh(Uri uri) {
        ...
        if (list != null) {
            ...
            if (com.google.android.gms.ads.internal.util.client.zzb.zzQ(2)) {
                zzin.m4114v("Received GMSG: " + path);
                for (String path2 : zze.keySet()) {
                    zzin.m4114v("  " + path2 + ": " + ((String) zze.get(path2)));
                }
            }
            for (zzdf zza : list) {
        ...
        zzin.m4114v("No GMSG handler found for GMSG: " + uri);
    }
    ...
    public void zzii() {
        synchronized (this.zzpV) {
            zzin.m4114v("Loading blank page in WebView, 2...");
            this.zzNH = true;
