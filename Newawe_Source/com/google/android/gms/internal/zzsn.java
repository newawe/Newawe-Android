...
public final class zzsn {
    ...
    public void zzau(long j) throws IOException {
        while ((-128 & j) != 0) {
            zzmz((((int) j) & TransportMediator.KEYCODE_MEDIA_PAUSE) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
            j >>>= 7;
        }
        zzmz((int) j);
    }
    ...
    public void zzmB(int i) throws IOException {
        while ((i & -128) != 0) {
            zzmz((i & TransportMediator.KEYCODE_MEDIA_PAUSE) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
            i >>>= 7;
        }
        zzmz(i);
    }
