...
public final class zzb {
    ...
    public static class zzc {
        public long zzC(long j) {
            return (long) (TimeZone.getDefault().getOffset(j) / DateUtils.MILLIS_IN_SECOND);
        }
    }

    /* renamed from: com.google.android.gms.clearcut.zzb.1 */
    static class C10941 extends com.google.android.gms.common.api.Api.zza<zzlw, NoOptions> {
        C10941() {
        }
