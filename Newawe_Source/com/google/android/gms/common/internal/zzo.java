...
public final class zzo {
    ...
    public void zza(Context context, String str, String str2, Throwable th) {
        ...
        while (i < stackTrace.length && i < 2) {
            ...
            stringBuilder.append(LineSeparator.Web);
            i++;
        }
        zzqt com_google_android_gms_internal_zzqt = new zzqt(context, 10);
        com_google_android_gms_internal_zzqt.zza("GMS_WTF", null, "GMS_WTF", stringBuilder.toString());
        com_google_android_gms_internal_zzqt.send();
        if (zzbU(7)) {
