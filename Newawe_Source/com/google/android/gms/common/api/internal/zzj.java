...
public final class zzj extends GoogleApiClient implements com.google.android.gms.common.api.internal.zzp.zza {
    ...
    /* renamed from: com.google.android.gms.common.api.internal.zzj.6 */
    class C05296 implements Runnable {
        final /* synthetic */ zzj zzaid;
        final /* synthetic */ FragmentActivity zzaih;

        C05296(zzj com_google_android_gms_common_api_internal_zzj, FragmentActivity fragmentActivity) {
    ...
    /* renamed from: com.google.android.gms.common.api.internal.zzj.1 */
    class C11021 implements zzd {
        final /* synthetic */ zzj zzaid;

        C11021(zzj com_google_android_gms_common_api_internal_zzj) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
        }
    ...
    /* renamed from: com.google.android.gms.common.api.internal.zzj.2 */
    class C11032 implements com.google.android.gms.common.internal.zzk.zza {
        final /* synthetic */ zzj zzaid;

        C11032(zzj com_google_android_gms_common_api_internal_zzj) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
        }
    ...
    /* renamed from: com.google.android.gms.common.api.internal.zzj.3 */
    class C11043 implements ConnectionCallbacks {
        final /* synthetic */ zzj zzaid;
        final /* synthetic */ AtomicReference zzaie;
        final /* synthetic */ zzv zzaif;

        C11043(zzj com_google_android_gms_common_api_internal_zzj, AtomicReference atomicReference, zzv com_google_android_gms_common_api_internal_zzv) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
    ...
    /* renamed from: com.google.android.gms.common.api.internal.zzj.4 */
    class C11054 implements OnConnectionFailedListener {
        final /* synthetic */ zzj zzaid;
        final /* synthetic */ zzv zzaif;

        C11054(zzj com_google_android_gms_common_api_internal_zzj, zzv com_google_android_gms_common_api_internal_zzv) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
            this.zzaif = com_google_android_gms_common_api_internal_zzv;
        }
    ...
    /* renamed from: com.google.android.gms.common.api.internal.zzj.5 */
    class C11065 implements ResultCallback<Status> {
        final /* synthetic */ GoogleApiClient zzabL;
        final /* synthetic */ zzj zzaid;
        final /* synthetic */ zzv zzaif;
        final /* synthetic */ boolean zzaig;

        C11065(zzj com_google_android_gms_common_api_internal_zzj, zzv com_google_android_gms_common_api_internal_zzv, boolean z, GoogleApiClient googleApiClient) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
            this.zzaif = com_google_android_gms_common_api_internal_zzv;
            this.zzaig = z;
    ...
    public zzj(Context context, Lock lock, Looper looper, zzf com_google_android_gms_common_internal_zzf, com.google.android.gms.common.zzc com_google_android_gms_common_zzc, com.google.android.gms.common.api.Api.zza<? extends zzrn, zzro> com_google_android_gms_common_api_Api_zza__extends_com_google_android_gms_internal_zzrn__com_google_android_gms_internal_zzro, Map<Api<?>, Integer> map, List<ConnectionCallbacks> list, List<OnConnectionFailedListener> list2, Map<com.google.android.gms.common.api.Api.zzc<?>, com.google.android.gms.common.api.Api.zzb> map2, int i, int i2, ArrayList<zzc> arrayList) {
        ...
        this.zzahW = Collections.newSetFromMap(new ConcurrentHashMap(16, 0.75f, 2));
        this.zzahZ = null;
        this.zzaia = null;
        this.zzaib = new C11021(this);
        this.zzaic = new C11032(this);
    ...
    private void zza(GoogleApiClient googleApiClient, zzv com_google_android_gms_common_api_internal_zzv, boolean z) {
        zzmf.zzamA.zzf(googleApiClient).setResultCallback(new C11065(this, com_google_android_gms_common_api_internal_zzv, z, googleApiClient));
    }
    ...
    public PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        if (this.zzahT.containsKey(zzmf.zzUI)) {
            ...
            GoogleApiClient build = new Builder(this.mContext).addApi(zzmf.API).addConnectionCallbacks(new C11043(this, atomicReference, com_google_android_gms_common_api_internal_zzv)).addOnConnectionFailedListener(new C11054(this, com_google_android_gms_common_api_internal_zzv)).setHandler(this.zzahR).build();
    ...
    public void stopAutoManage(@NonNull FragmentActivity lifecycleActivity) {
        if (this.zzagp >= 0) {
            ...
            if (zza == null) {
                new Handler(this.mContext.getMainLooper()).post(new C05296(this, lifecycleActivity));
                return;
            } else {
                zza.zzbD(this.zzagp);
                return;
    ...
    String zzpH() {
        ...
        dump(StringUtils.EMPTY, null, new PrintWriter(stringWriter), null);
