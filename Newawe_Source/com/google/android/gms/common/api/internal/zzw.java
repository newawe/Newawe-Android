...
public class zzw extends Fragment implements OnCancelListener {
    ...
    private static com.google.android.gms.common.api.internal.zzw zzpO() {
        ...
        r0 = java.lang.Class.forName(r0);	 Catch:{ ClassNotFoundException -> 0x003d, LinkageError -> 0x0011, SecurityException -> 0x003b }
    L_0x0008:
        if (r0 == 0) goto L_0x0033;
    L_0x000a:
        r0 = r0.newInstance();	 Catch:{ IllegalAccessException -> 0x0039, InstantiationException -> 0x0035, ExceptionInInitializerError -> 0x0037, RuntimeException -> 0x0023 }
        r0 = (com.google.android.gms.common.api.internal.zzw) r0;	 Catch:{ IllegalAccessException -> 0x0039, InstantiationException -> 0x0035, ExceptionInInitializerError -> 0x0037, RuntimeException -> 0x0023 }
    L_0x0010:
        return r0;
    L_0x0011:
        r0 = move-exception;
