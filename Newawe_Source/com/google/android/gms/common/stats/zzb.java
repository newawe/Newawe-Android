...
public class zzb {
    ...
    private zzb() {
        ...
        this.zzanu = new zze(NodeFilter.SHOW_DOCUMENT_FRAGMENT, ((Long) zza.zzanE.get()).longValue());
        this.zzanw = new zze(NodeFilter.SHOW_DOCUMENT_FRAGMENT, ((Long) zza.zzanE.get()).longValue());
    }
    ...
    private boolean zzc(Context context, Intent intent) {
        ...
        return (component == null || (zzd.zzakE && zze.GOOGLE_PLAY_SERVICES_PACKAGE.equals(component.getPackageName()))) ? false : zzmp.zzk(context, component.getPackageName());
    }
