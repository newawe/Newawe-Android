...
public abstract class Task implements Parcelable {
    ...
    Task(Parcel in) {
        ...
        this.zzaMi = in.readInt() == NETWORK_STATE_UNMETERED;
        if (in.readInt() != NETWORK_STATE_UNMETERED) {
            z = false;
        }
        this.zzaMj = z;
        this.zzaMk = NETWORK_STATE_ANY;
        this.zzaMl = false;
    ...
    public static void zza(zzd com_google_android_gms_gcm_zzd) {
        if (com_google_android_gms_gcm_zzd != null) {
            ...
            if (zzym == NETWORK_STATE_UNMETERED || zzym == 0) {
                ...
                } else if (zzym == NETWORK_STATE_UNMETERED && zzyn < 10) {
    ...
    public void toBundle(Bundle bundle) {
        ...
        bundle.putString(NotificationCompatApi21.CATEGORY_SERVICE, this.zzaMh);
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeInt(this.zzaMi ? NETWORK_STATE_UNMETERED : NETWORK_STATE_CONNECTED);
        if (!this.zzaMj) {
