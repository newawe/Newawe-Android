...
class zzb {
    ...
    static synchronized zzb zzc(Context context, Class<? extends GcmListenerService> cls) {
        ...
        synchronized (zzb.class) {
            ...
            com_google_android_gms_gcm_zzb = zzaLC;
        }
    ...
    private Uri zzdX(String str) {
        return TextUtils.isEmpty(str) ? null : (CookieSpecs.DEFAULT.equals(str) || this.mContext.getResources().getIdentifier(str, "raw", this.mContext.getPackageName()) == 0) ? RingtoneManager.getDefaultUri(2) : Uri.parse("android.resource://" + this.mContext.getPackageName() + "/raw/" + str);
    }
    ...
    private String zzf(Bundle bundle, String str) {
        ...
        Resources resources = this.mContext.getResources();
        int identifier = resources.getIdentifier(zze2, SchemaSymbols.ATTVAL_STRING, this.mContext.getPackageName());
        if (identifier == 0) {
    ...
    static boolean zzy(Bundle bundle) {
        return SchemaSymbols.ATTVAL_TRUE_1.equals(zze(bundle, "gcm.n.e")) || zze(bundle, "gcm.n.icon") != null;
    }
