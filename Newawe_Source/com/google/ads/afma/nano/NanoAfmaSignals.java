...
public interface NanoAfmaSignals {
    ...
    public static final class AFMASignals extends zzsu {
        ...
        public void writeTo(zzsn output) throws IOException {
            ...
            if (this.rawAdAttestationSignal != null) {
                output.zza((int) HttpStatus.SC_CREATED, this.rawAdAttestationSignal);
            }
            super.writeTo(output);
        }
        ...
        protected int zzz() {
            ...
            return this.rawAdAttestationSignal != null ? zzz + zzsn.zzc((int) HttpStatus.SC_CREATED, this.rawAdAttestationSignal) : zzz;
        }
    }
