...
public class BooleanUtils {
    ...
    public static Boolean toBooleanObject(String str) {
        if (str == SchemaSymbols.ATTVAL_TRUE) {
            return Boolean.TRUE;
        }
        if (str == null) {
            return null;
    ...
    public static String toStringTrueFalse(Boolean bool) {
        return toString(bool, SchemaSymbols.ATTVAL_TRUE, SchemaSymbols.ATTVAL_FALSE, null);
    }
    ...
    public static String toStringTrueFalse(boolean bool) {
        return toString(bool, SchemaSymbols.ATTVAL_TRUE, SchemaSymbols.ATTVAL_FALSE);
    }
