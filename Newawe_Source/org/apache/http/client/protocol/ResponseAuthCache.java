    ...
    public void process(HttpResponse response, HttpContext context) throws HttpException, IOException {
        ...
        if (!(target == null || targetState == null)) {
            ...
            if (isCachable(targetState)) {
                ...
                switch (C09231.$SwitchMap$org$apache$http$auth$AuthProtocolState[targetState.getState().ordinal()]) {
        ...
        if (proxy != null && proxyState != null) {
            ...
            if (isCachable(proxyState)) {
                ...
                switch (C09231.$SwitchMap$org$apache$http$auth$AuthProtocolState[proxyState.getState().ordinal()]) {
                    case DurationDV.YEARMONTHDURATION_TYPE /*1*/:
