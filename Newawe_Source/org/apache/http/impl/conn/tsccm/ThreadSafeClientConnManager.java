...
public class ThreadSafeClientConnManager implements ClientConnectionManager {
    ...
    class C12911 implements ClientConnectionRequest {
        final /* synthetic */ PoolEntryRequest val$poolRequest;
        final /* synthetic */ HttpRoute val$route;

        C12911(PoolEntryRequest poolEntryRequest, HttpRoute httpRoute) {
    ...
    public ClientConnectionRequest requestConnection(HttpRoute route, Object state) {
        return new C12911(this.pool.requestPoolEntry(route, state), route);
    }
