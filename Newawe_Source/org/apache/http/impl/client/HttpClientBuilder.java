...
public class HttpClientBuilder {
    ...
    class C09271 implements Closeable {
        final /* synthetic */ IdleConnectionEvictor val$connectionEvictor;

        C09271(IdleConnectionEvictor idleConnectionEvictor) {
    ...
    class C09282 implements Closeable {
        final /* synthetic */ HttpClientConnectionManager val$cm;

        C09282(HttpClientConnectionManager httpClientConnectionManager) {
    ...
    public CloseableHttpClient build() {
        ...
        if (!this.connManagerShared) {
            ...
            if (this.evictExpiredConnections || this.evictIdleConnections) {
                ...
                closeablesCopy.add(new C09271(idleConnectionEvictor));
                idleConnectionEvictor.start();
            }
            closeablesCopy.add(new C09282(cm));
        }
