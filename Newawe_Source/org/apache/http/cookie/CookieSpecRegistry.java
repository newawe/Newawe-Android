...
public final class CookieSpecRegistry implements Lookup<CookieSpecProvider> {
    ...
    class C12811 implements CookieSpecProvider {
        ...
        public CookieSpec create(HttpContext context) {
            return CookieSpecRegistry.this.getCookieSpec(this.val$name, ((HttpRequest) context.getAttribute(ExecutionContext.HTTP_REQUEST)).getParams());
        }
    }
