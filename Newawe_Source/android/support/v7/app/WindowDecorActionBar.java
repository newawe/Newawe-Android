...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C09793 implements ViewPropertyAnimatorUpdateListener {
        C09793() {
        }
    ...
    class C12951 extends ViewPropertyAnimatorListenerAdapter {
        C12951() {
        }
    ...
    class C12962 extends ViewPropertyAnimatorListenerAdapter {
        C12962() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C12951();
        this.mShowListener = new C12962();
        this.mUpdateListener = new C09793();
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0131R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0131R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0131R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0131R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0131R.styleable.ActionBar, C0131R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0131R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0131R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0131R.attr.actionBarWidgetTheme, outValue, true);
