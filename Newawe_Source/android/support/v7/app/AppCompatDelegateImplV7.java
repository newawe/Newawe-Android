...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C01261 implements Runnable {
        ...
        public void run() {
            ...
            if ((AppCompatDelegateImplV7.this.mInvalidatePanelMenuFeatures & UTF16Reader.DEFAULT_BUFFER_SIZE) != 0) {
                AppCompatDelegateImplV7.this.doInvalidatePanelMenu(C0302R.styleable.Theme_spinnerStyle);
            }
    ...
    class C01275 implements Runnable {
        ...
        public void run() {
            ...
            AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C12921());
        }
    }
    ...
    private static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            ...
            static class C09771 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C09771() {
                }
            ...
            static {
                CREATOR = ParcelableCompat.newCreator(new C09771());
            }
        }
    ...
    class C09753 implements OnFitSystemWindowsListener {
        C09753() {
        }
    ...
    class C09764 implements OnAttachListener {
        C09764() {
        }
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder subMenu) {
            ...
            if (cb != null) {
                cb.onMenuOpened(C0302R.styleable.Theme_spinnerStyle, subMenu);
            }
            return true;
        }
    ...
    class ActionModeCallbackWrapperV7 implements ActionMode.Callback {
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV7.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C12941());
            }
    ...
    class C12936 extends ViewPropertyAnimatorListenerAdapter {
        C12936() {
        }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (!isDestroyed()) {
                if (st == null || st.menu == null) {
                    invalidatePanelMenu(C0302R.styleable.Theme_spinnerStyle);
                }
            }
        }
    }
    ...
    private ViewGroup createSubDecor() {
        ...
        if (a.hasValue(C0131R.styleable.Theme_windowActionBar)) {
            if (a.getBoolean(C0131R.styleable.Theme_windowNoTitle, false)) {
                ...
                requestWindowFeature(C0302R.styleable.Theme_spinnerStyle);
            }
            if (a.getBoolean(C0131R.styleable.Theme_windowActionBarOverlay, false)) {
                requestWindowFeature(C0302R.styleable.Theme_switchStyle);
            }
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C09742());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C09753());
                }
                ...
                if (this.mOverlayActionBar) {
                    this.mDecorContentParent.initFeature(C0302R.styleable.Theme_switchStyle);
                }
            ...
            abcContent.setAttachListener(new C09764());
            return subDecor;
        }
        a.recycle();
    ...
    public boolean requestWindowFeature(int featureId) {
        ...
        if (this.mWindowNoTitle && featureId == C0302R.styleable.Theme_spinnerStyle) {
            return false;
        }
    ...
    void onPanelClosed(int featureId, Menu menu) {
        if (featureId == C0302R.styleable.Theme_spinnerStyle) {
            ActionBar ab = getSupportActionBar();
            if (ab != null) {
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    this.mFadeAnim.setListener(new C12936());
                    if (this.mActionModePopup != null) {
    ...
    boolean onKeyUp(int keyCode, KeyEvent event) {
        switch (keyCode) {
            case ConnectionResult.SIGN_IN_REQUIRED /*4*/:
                ...
                break;
            case C0302R.styleable.Theme_colorPrimary /*82*/:
    ...
    private void reopenMenu(MenuBuilder menu, boolean toggleMenuMode) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && toggleMenuMode) {
            ...
            if (!isDestroyed()) {
                cb.onPanelClosed(C0302R.styleable.Theme_spinnerStyle, getPanelState(0, true).menu);
            }
            ...
            if (st.menu != null && !st.refreshMenuContent && cb.onPreparePanel(0, st.createdPanelView, st.menu)) {
                cb.onMenuOpened(C0302R.styleable.Theme_spinnerStyle, st.menu);
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        Context context = this.mContext;
        if ((st.featureId == 0 || st.featureId == C0302R.styleable.Theme_spinnerStyle) && this.mDecorContentParent != null) {
            TypedValue outValue = new TypedValue();
    ...
    private boolean preparePanel(PanelFeatureState st, KeyEvent event) {
        ...
        if (st.featureId == 0 || st.featureId == C0302R.styleable.Theme_spinnerStyle) {
    ...
    private void checkCloseActionMenu(MenuBuilder menu) {
        if (!this.mClosingActionMenu) {
            ...
            Window.Callback cb = getWindowCallback();
            if (!(cb == null || isDestroyed())) {
                cb.onPanelClosed(C0302R.styleable.Theme_spinnerStyle, menu);
            }
    ...
    private void doInvalidatePanelMenu(int featureId) {
        ...
        st.refreshDecorView = true;
        if ((featureId == C0302R.styleable.Theme_spinnerStyle || featureId == 0) && this.mDecorContentParent != null) {
    ...
    private int sanitizeWindowFeatureId(int featureId) {
        if (featureId == 8) {
            ...
            return C0302R.styleable.Theme_spinnerStyle;
        } else if (featureId != 9) {
            return featureId;
        } else {
            Log.i("AppCompatDelegate", "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY id when requesting this feature.");
            return C0302R.styleable.Theme_switchStyle;
        }
    }
