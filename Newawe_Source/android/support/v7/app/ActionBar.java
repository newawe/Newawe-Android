...
public abstract class ActionBar {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context c, AttributeSet attrs) {
            ...
            TypedArray a = c.obtainStyledAttributes(attrs, C0131R.styleable.ActionBarLayout);
            this.gravity = a.getInt(C0131R.styleable.ActionBarLayout_android_layout_gravity, ActionBar.NAVIGATION_MODE_STANDARD);
            a.recycle();
        }
