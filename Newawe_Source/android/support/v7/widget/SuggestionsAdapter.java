...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            this.mIconRefine = (ImageView) v.findViewById(C0131R.id.edit_query);
        }
    }
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
        String query = constraint == null ? StringUtils.EMPTY : constraint.toString();
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        ((ImageView) v.findViewById(C0131R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return v;
    }
    ...
    private CharSequence formatUrl(CharSequence url) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0131R.attr.textColorSearchUrl, colorValue, true);
    ...
    private Drawable getDrawableFromResourceValue(String drawableId) {
        Drawable drawable;
        if (drawableId == null || drawableId.length() == 0 || SchemaSymbols.ATTVAL_FALSE_0.equals(drawableId)) {
            return null;
        }
        try {
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchable, String query, int limit) {
        ...
        Builder uriBuilder = new Builder().scheme("content").authority(authority).query(StringUtils.EMPTY).fragment(StringUtils.EMPTY);
