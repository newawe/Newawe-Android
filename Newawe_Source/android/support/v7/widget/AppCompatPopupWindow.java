...
public class AppCompatPopupWindow extends PopupWindow {
    ...
    static class C01431 implements OnScrollChangedListener {
        ...
        C01431(Field field, PopupWindow popupWindow, OnScrollChangedListener onScrollChangedListener) {
    ...
    public AppCompatPopupWindow(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0131R.styleable.PopupWindow, defStyleAttr, 0);
        if (a.hasValue(C0131R.styleable.PopupWindow_overlapAnchor)) {
            setSupportOverlapAnchor(a.getBoolean(C0131R.styleable.PopupWindow_overlapAnchor, COMPAT_OVERLAP_ANCHOR));
        }
        setBackgroundDrawable(a.getDrawable(C0131R.styleable.PopupWindow_android_popupBackground));
        a.recycle();
    ...
    private static void wrapOnScrollChangedListener(PopupWindow popup) {
        try {
            ...
            fieldListener.set(popup, new C01431(fieldAnchor, popup, (OnScrollChangedListener) fieldListener.get(popup)));
        } catch (Exception e) {
