...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C01534 implements OnFocusChangeListener {
        C01534() {
        }
    ...
    class C01545 implements OnLayoutChangeListener {
        C01545() {
        }
    ...
    class C01556 implements OnGlobalLayoutListener {
        C01556() {
        }
    ...
    class C01567 implements OnClickListener {
        C01567() {
        }
    ...
    class C01578 implements OnKeyListener {
        C01578() {
        }
    ...
    class C01589 implements OnEditorActionListener {
        C01589() {
        }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0131R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0131R.attr.searchViewStyle);
    }

    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.mShowImeRunnable = new C01501();
        this.mUpdateDrawableStateRunnable = new C01512();
        this.mReleaseCursorRunnable = new C01523();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01567();
        this.mTextKeyListener = new C01578();
        this.mOnEditorActionListener = new C01589();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0131R.styleable.SearchView, defStyleAttr, 0);
        this.mTintManager = a.getTintManager();
        LayoutInflater.from(context).inflate(a.getResourceId(C0131R.styleable.SearchView_layout, C0131R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0131R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0131R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0131R.id.search_plate);
        this.mSubmitArea = findViewById(C0131R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0131R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0131R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0131R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0131R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0131R.id.search_mag_icon);
        this.mSearchPlate.setBackgroundDrawable(a.getDrawable(C0131R.styleable.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(a.getDrawable(C0131R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0131R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0131R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0131R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0131R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0131R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0131R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0131R.styleable.SearchView_suggestionRowLayout, C0131R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0131R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C01534());
        setIconifiedByDefault(a.getBoolean(C0131R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0131R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0131R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0131R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0131R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0131R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0131R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C01545());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C01556());
    }
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0131R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0131R.dimen.abc_dropdownitem_text_padding_left) : 0;
