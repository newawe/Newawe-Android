...
public class TransportMediator extends TransportController {
    ...
    class C00432 implements Callback {
        C00432() {
        }
    ...
    class C09571 implements TransportMediatorCallback {
        C09571() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C09571();
        this.mKeyEventCallback = new C00432();
