...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class C09553 extends Result<List<MediaItem>> {
        final /* synthetic */ ConnectionRecord val$connection;
        final /* synthetic */ String val$parentId;

        C09553(Object x0, String str, ConnectionRecord connectionRecord) {
            this.val$parentId = str;
    ...
    class C09564 extends Result<MediaItem> {
        final /* synthetic */ ResultReceiver val$receiver;

        C09564(Object x0, ResultReceiver resultReceiver) {
    ...
    private class ServiceBinder extends Stub {
        ...
        class C00351 implements Runnable {
            ...
            C00351(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks, String str, Bundle bundle, int i) {
        ...
        class C00362 implements Runnable {
            ...
            C00362(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks) {
                this.val$callbacks = iMediaBrowserServiceCompatCallbacks;
            }
        ...
        class C00373 implements Runnable {
            ...
            C00373(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks, String str) {
                this.val$callbacks = iMediaBrowserServiceCompatCallbacks;
                this.val$id = str;
            }
        ...
        class C00384 implements Runnable {
            ...
            C00384(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks, String str) {
                this.val$callbacks = iMediaBrowserServiceCompatCallbacks;
                this.val$id = str;
            }
        ...
        class C00395 implements Runnable {
            ...
            C00395(String str, ResultReceiver resultReceiver) {
        ...
        public void connect(String pkg, Bundle rootHints, IMediaBrowserServiceCompatCallbacks callbacks) {
            ...
            if (MediaBrowserServiceCompat.this.isValidPackage(pkg, uid)) {
                MediaBrowserServiceCompat.this.mHandler.post(new C00351(callbacks, pkg, rootHints, uid));
                return;
            }
        ...
        public void disconnect(IMediaBrowserServiceCompatCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00362(callbacks));
        }

        public void addSubscription(String id, IMediaBrowserServiceCompatCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00373(callbacks, id));
        }

        public void removeSubscription(String id, IMediaBrowserServiceCompatCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00384(callbacks, id));
        }

        public void getMediaItem(String mediaId, ResultReceiver receiver) {
            if (!TextUtils.isEmpty(mediaId) && receiver != null) {
                MediaBrowserServiceCompat.this.mHandler.post(new C00395(mediaId, receiver));
            }
        }
    }
    ...
    public void setSessionToken(Token token) {
        if (token == null) {
            ...
            this.mSession = token;
            this.mHandler.post(new C00331(token));
        }
    }
    ...
    public void notifyChildrenChanged(@NonNull String parentId) {
        ...
        this.mHandler.post(new C00342(parentId));
    }
    ...
    private void performLoadChildren(String parentId, ConnectionRecord connection) {
        Result<List<MediaItem>> result = new C09553(parentId, parentId, connection);
    ...
    private void performLoadItem(String itemId, ResultReceiver receiver) {
        Result<MediaItem> result = new C09564(itemId, receiver);
