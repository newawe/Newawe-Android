...
class TransportMediatorJellybeanMR2 {
    ...
    class C00441 implements OnWindowAttachListener {
        C00441() {
        }
    ...
    class C00452 implements OnWindowFocusChangeListener {
        C00452() {
        }
    ...
    class C00474 implements OnAudioFocusChangeListener {
        C00474() {
        }
    ...
    class C00485 implements OnGetPlaybackPositionListener {
        C00485() {
        }
    ...
    class C00496 implements OnPlaybackPositionUpdateListener {
        C00496() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C00441();
        this.mWindowFocusListener = new C00452();
        this.mMediaButtonReceiver = new C00463();
        this.mAudioFocusChangeListener = new C00474();
        this.mGetPlaybackPositionListener = new C00485();
        this.mPlaybackPositionUpdateListener = new C00496();
        this.mPlayState = 0;
