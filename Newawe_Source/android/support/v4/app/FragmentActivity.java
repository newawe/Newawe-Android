...
public class FragmentActivity extends BaseFragmentActivityHoneycomb implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    private static String viewToString(View view) {
        ...
        out.append(c);
        out.append(view.willNotDraw() ? ClassUtils.PACKAGE_SEPARATOR_CHAR : 'D');
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        int index = (requestCode >> 8) & MotionEventCompat.ACTION_MASK;
        if (index != 0) {
            index--;
            int activeFragmentsCount = this.mFragments.getActiveFragmentsCount();
            if (activeFragmentsCount == 0 || index < 0 || index >= activeFragmentsCount) {
            ...
            if (frag == null) {
                ...
                frag.onRequestPermissionsResult(requestCode & MotionEventCompat.ACTION_MASK, permissions, grantResults);
            }
        }
    }
    ...
    private void requestPermissionsFromFragment(Fragment fragment, String[] permissions, int requestCode) {
        if (requestCode == -1) {
            ...
            ActivityCompat.requestPermissions(this, permissions, ((fragment.mIndex + MSG_REALLY_STOPPED) << 8) + (requestCode & MotionEventCompat.ACTION_MASK));
        }
    }
}
