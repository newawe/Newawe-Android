...
class SearchViewCompatHoneycomb {
    ...
    static class C01021 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C01021(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C01032 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C01032(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
