...
public class ViewDragHelper {
    ...
    static class C01141 implements Interpolator {
        C01141() {
        }
    ...
    private ViewDragHelper(Context context, ViewGroup forParent, Callback cb) {
        ...
        this.mSetIdleRunnable = new C01152();
        if (forParent == null) {
    ...
    private void releaseViewForPointerUp() {
        this.mVelocityTracker.computeCurrentVelocity(DateUtils.MILLIS_IN_SECOND, this.mMaxVelocity);
