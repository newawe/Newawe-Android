...
class AccessibilityManagerCompatIcs {
    ...
    static class C00861 implements AccessibilityStateChangeListener {
        final /* synthetic */ AccessibilityStateChangeListenerBridge val$bridge;

        C00861(AccessibilityStateChangeListenerBridge accessibilityStateChangeListenerBridge) {
