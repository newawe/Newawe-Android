...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C09671 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C09671() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C09671());
        }
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            if (event.getEventType() == UTF16Reader.DEFAULT_BUFFER_SIZE && ViewPager.this.mAdapter != null) {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            if (ViewPager.this.canScrollHorizontally(ViewPager.SCROLL_STATE_DRAGGING)) {
                info.addAction((int) UTF16Reader.DEFAULT_BUFFER_SIZE);
            }
            if (ViewPager.this.canScrollHorizontally(ViewPager.INVALID_POINTER)) {
                info.addAction((int) UCSReader.DEFAULT_BUFFER_SIZE);
            }
        }
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle args) {
            ...
            switch (action) {
                case UTF16Reader.DEFAULT_BUFFER_SIZE /*4096*/:
                    if (!ViewPager.this.canScrollHorizontally(ViewPager.SCROLL_STATE_DRAGGING)) {
                ...
                switch (action & MotionEventCompat.ACTION_MASK) {
                    ...
                    case SCROLL_STATE_DRAGGING /*1*/:
                        if (this.mIsBeingDragged) {
                            ...
                            velocityTracker.computeCurrentVelocity(DateUtils.MILLIS_IN_SECOND, (float) this.mMaximumVelocity);
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
        if (event.getEventType() == UTF16Reader.DEFAULT_BUFFER_SIZE) {
