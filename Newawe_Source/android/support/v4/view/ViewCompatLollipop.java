...
class ViewCompatLollipop {
    ...
    static class C00781 implements OnApplyWindowInsetsListener {
        final /* synthetic */ OnApplyWindowInsetsListener val$listener;

        C00781(OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
    ...
    public static void setOnApplyWindowInsetsListener(View view, OnApplyWindowInsetsListener listener) {
        view.setOnApplyWindowInsetsListener(new C00781(listener));
    }
