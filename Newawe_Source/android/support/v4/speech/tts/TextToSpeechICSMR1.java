...
class TextToSpeechICSMR1 {
    ...
    static class C00671 extends UtteranceProgressListener {
        final /* synthetic */ UtteranceProgressListenerICSMR1 val$listener;

        C00671(UtteranceProgressListenerICSMR1 utteranceProgressListenerICSMR1) {
    ...
    static class C00682 implements OnUtteranceCompletedListener {
        final /* synthetic */ UtteranceProgressListenerICSMR1 val$listener;

        C00682(UtteranceProgressListenerICSMR1 utteranceProgressListenerICSMR1) {
            this.val$listener = utteranceProgressListenerICSMR1;
        }
    ...
    static void setUtteranceProgressListener(TextToSpeech tts, UtteranceProgressListenerICSMR1 listener) {
        if (VERSION.SDK_INT >= 15) {
            tts.setOnUtteranceProgressListener(new C00671(listener));
        } else {
            tts.setOnUtteranceCompletedListener(new C00682(listener));
        }
    }
}
